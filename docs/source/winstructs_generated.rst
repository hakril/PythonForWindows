...
'''''''''''''''''''''''''''''''
.. class:: BG_BASIC_CREDENTIALS

    Alias for :class:`__MIDL_IBackgroundCopyJob2_0003`

.. class:: __MIDL_IBackgroundCopyJob2_0003
...
'''''''''''''''''''''''''''''''
.. class:: BG_AUTH_CREDENTIALS_UNION

    Alias for :class:`__MIDL_IBackgroundCopyJob2_0004`
...
''''''''''''''''''''''
.. class:: BG_JOB_REPLY_PROGRESS

    Alias for :class:`_BG_JOB_REPLY_PROGRESS`

.. class:: _BG_JOB_REPLY_PROGRESS
...
.. class:: BG_FILE_RANGE
    ...
    Alias for :class:`_BG_FILE_RANGE`

.. class:: _BG_FILE_RANGE

    .. attribute:: InitialOffset
...
.. class:: IO_RANGE
    ...
    Alias for :class:`IO_Range_s`

.. class:: PIO_RANGE

    Pointer to :class:`IO_Range_s`
...
.. class:: MEM_DES
    ...
    Alias for :class:`Mem_Des_s`

.. class:: PMEM_DES

    Pointer to :class:`Mem_Des_s`
...
.. class:: Mem_Des_s
    ...
    .. attribute:: MD_Alloc_Base

        :class:`DWORDLONG`


    .. attribute:: MD_Alloc_End
...
.. class:: MEM_RANGE
    ...
    Alias for :class:`Mem_Range_s`

.. class:: PMEM_RANGE

    Pointer to :class:`Mem_Range_s`
...
.. class:: DMA_RANGE
    ...
    Alias for :class:`DMA_Range_s`

.. class:: PDMA_RANGE

    Pointer to :class:`DMA_Range_s`
...
.. class:: IRQ_DES_64
    ...
    Alias for :class:`IRQ_Des_64_s`

.. class:: PIRQ_DES_64

    Pointer to :class:`IRQ_Des_64_s`

.. class:: IRQ_Des_64_s

    .. attribute:: IRQD_Count
    ...
    .. attribute:: IRQD_Flags

        :class:`DWORD`


    .. attribute:: IRQD_Alloc_Num

        :class:`ULONG`


    .. attribute:: IRQD_Affinity
...
.. class:: PIRQ_DES_32
    ...
    Pointer to :class:`IRQ_Des_32_s`

.. class:: IRQ_DES_32

    Alias for :class:`IRQ_Des_32_s`
...
.. class:: IRQ_RANGE
    ...
    Alias for :class:`IRQ_Range_s`

.. class:: PIRQ_RANGE

    Pointer to :class:`IRQ_Range_s`
...
.. class:: BUSNUMBER_DES
    ...
    Alias for :class:`BusNumber_Des_s`

.. class:: PBUSNUMBER_DES

    Pointer to :class:`BusNumber_Des_s`

.. class:: BusNumber_Des_s

    .. attribute:: BUSD_Count
    ...
    .. attribute:: BUSD_Flags

        :class:`DWORD`


    .. attribute:: BUSD_Alloc_Base

        :class:`ULONG`


    .. attribute:: BUSD_Alloc_End

        :class:`ULONG`

BusNumber_Range_s
'''''''''''''''''
.. class:: PBUSNUMBER_RANGE

    Pointer to :class:`BusNumber_Range_s`

.. class:: BUSNUMBER_RANGE

    Alias for :class:`BusNumber_Range_s`

.. class:: BusNumber_Range_s
    ...
    .. attribute:: BUSR_nBusNumbers

        :class:`ULONG`


    .. attribute:: BUSR_Flags

        :class:`ULONG`

BusNumber_Resource_s
''''''''''''''''''''
.. class:: BUSNUMBER_RESOURCE

    Alias for :class:`BusNumber_Resource_s`

.. class:: PBUSNUMBER_RESOURCE

    Pointer to :class:`BusNumber_Resource_s`

.. class:: BusNumber_Resource_s

    .. attribute:: BusNumber_Header
    ...
    .. attribute:: BusNumber_Data
        ...
        :class:`BUSNUMBER_RANGE` ``[<winstruct.ComplexArrayExpression object at 0x03B7EF50>]``

CS_Des_s
''''''''
.. class:: PCS_DES

    Pointer to :class:`CS_Des_s`

.. class:: CS_DES

    Alias for :class:`CS_Des_s`

.. class:: CS_Des_s

    .. attribute:: CSD_SignatureLength

        :class:`DWORD`


    .. attribute:: CSD_LegacyDataOffset

        :class:`DWORD`


    .. attribute:: CSD_LegacyDataSize
    ...
    .. attribute:: CSD_Signature
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x037C0190>]``

CS_Resource_s
'''''''''''''
.. class:: PCS_RESOURCE

    Pointer to :class:`CS_Resource_s`

.. class:: CS_RESOURCE

    Alias for :class:`CS_Resource_s`
...
.. class:: PDMA_RESOURCE
    ...
    Pointer to :class:`DMA_Resource_s`

.. class:: DMA_RESOURCE

    Alias for :class:`DMA_Resource_s`

.. class:: DMA_Resource_s

    .. attribute:: DMA_Header
    ...
    .. attribute:: DMA_Data
        ...
        :class:`DMA_RANGE` ``[<winstruct.ComplexArrayExpression object at 0x037C05B0>]``
...
.. class:: IO_RESOURCE
    ...
    Alias for :class:`IO_Resource_s`

.. class:: PIO_RESOURCE

    Pointer to :class:`IO_Resource_s`
...
.. class:: IO_Resource_s
    ...
    .. attribute:: IO_Data
        ...
        :class:`IO_RANGE` ``[<winstruct.ComplexArrayExpression object at 0x037C08F0>]``

IRQ_Resource_32_s
'''''''''''''''''
.. class:: PIRQ_RESOURCE_32

    Pointer to :class:`IRQ_Resource_32_s`

.. class:: IRQ_RESOURCE_32

    Alias for :class:`IRQ_Resource_32_s`

.. class:: IRQ_Resource_32_s

    .. attribute:: IRQ_Header
    ...
    .. attribute:: IRQ_Data
        ...
        :class:`IRQ_RANGE` ``[<winstruct.ComplexArrayExpression object at 0x037C0A30>]``

IRQ_Resource_64_s
'''''''''''''''''
.. class:: IRQ_RESOURCE_64

    Alias for :class:`IRQ_Resource_64_s`

.. class:: PIRQ_RESOURCE_64

    Pointer to :class:`IRQ_Resource_64_s`
...
.. class:: IRQ_Resource_64_s
    ...
    .. attribute:: IRQ_Data
        ...
        :class:`IRQ_RANGE` ``[<winstruct.ComplexArrayExpression object at 0x037C0B50>]``

Mem_Resource_s
''''''''''''''
.. class:: MEM_RESOURCE

    Alias for :class:`Mem_Resource_s`

.. class:: PMEM_RESOURCE

    Pointer to :class:`Mem_Resource_s`
...
.. class:: Mem_Resource_s
    ...
    .. attribute:: MEM_Data
        ...
        :class:`MEM_RANGE` ``[<winstruct.ComplexArrayExpression object at 0x037C0C70>]``

MfCard_Des_s
''''''''''''
.. class:: MFCARD_DES

    Alias for :class:`MfCard_Des_s`

.. class:: PMFCARD_DES

    Pointer to :class:`MfCard_Des_s`
...
.. class:: MfCard_Des_s
    ...
    .. attribute:: PMF_ConfigOptions

        :class:`BYTE`


    .. attribute:: PMF_IoResourceIndex
    ...
    .. attribute:: PMF_Reserved
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x037C0EB0>]``
...
MfCard_Resource_s
'''''''''''''''''
.. class:: PMFCARD_RESOURCE

    Pointer to :class:`MfCard_Resource_s`

.. class:: MFCARD_RESOURCE

    Alias for :class:`MfCard_Resource_s`

.. class:: MfCard_Resource_s

    .. attribute:: MfCard_Header
...
.. class:: PCCARD_DES
    ...
    Alias for :class:`PcCard_Des_s`

.. class:: PPCCARD_DES

    Pointer to :class:`PcCard_Des_s`
...
.. class:: PcCard_Des_s
    ...
    .. attribute:: PCD_Reserved
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x037C41D0>]``
    ...
    .. attribute:: PCD_MemoryCardBase
        ...
        :class:`DWORD` ``[<winstruct.ComplexArrayExpression object at 0x037C42B0>]``


    .. attribute:: PCD_MemoryFlags

        :class:`WORD` ``[<winstruct.ComplexArrayExpression object at 0x037C4310>]``


    .. attribute:: PCD_IoFlags

        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x037C4390>]``

PcCard_Resource_s
'''''''''''''''''
.. class:: PPCCARD_RESOURCE

    Pointer to :class:`PcCard_Resource_s`

.. class:: PCCARD_RESOURCE

    Alias for :class:`PcCard_Resource_s`

.. class:: PcCard_Resource_s

    .. attribute:: PcCard_Header

        :class:`PCCARD_DES`

Mem_Large_Range_s
'''''''''''''''''
.. class:: PMEM_LARGE_RANGE

    Pointer to :class:`Mem_Large_Range_s`

.. class:: MEM_LARGE_RANGE

    Alias for :class:`Mem_Large_Range_s`

.. class:: Mem_Large_Range_s
    ...
    .. attribute:: MLR_Reserved

        :class:`DWORD`

Mem_Large_Des_s
'''''''''''''''
.. class:: PMEM_LARGE_DES

    Pointer to :class:`Mem_Large_Des_s`

.. class:: MEM_LARGE_DES

    Alias for :class:`Mem_Large_Des_s`

.. class:: Mem_Large_Des_s
    ...
    .. attribute:: MLD_Alloc_Base

        :class:`DWORDLONG`


    .. attribute:: MLD_Alloc_End
    ...
    .. attribute:: MLD_Reserved

        :class:`DWORD`

Mem_Large_Resource_s
''''''''''''''''''''
.. class:: MEM_LARGE_RESOURCE

    Alias for :class:`Mem_Large_Resource_s`

.. class:: PMEM_LARGE_RESOURCE

    Pointer to :class:`Mem_Large_Resource_s`

.. class:: Mem_Large_Resource_s

    .. attribute:: MEM_LARGE_Header
    ...
    .. attribute:: MEM_LARGE_Data
        ...
        :class:`MEM_LARGE_RANGE` ``[<winstruct.ComplexArrayExpression object at 0x037C4990>]``
...
.. class:: tagSAFEARRAY
    ...
    .. attribute:: rgsabound
        ...
        :class:`SAFEARRAYBOUND` ``[<winstruct.ComplexArrayExpression object at 0x037CCD30>]``
...
.. class:: PARAMDESCEX
    ...
    Alias for :class:`tagPARAMDESCEX`

.. class:: LPPARAMDESCEX

    Pointer to :class:`tagPARAMDESCEX`

.. class:: tagPARAMDESCEX
...
.. class:: LPPARAMDESC
    ...
    Pointer to :class:`tagPARAMDESC`

.. class:: PARAMDESC

    Alias for :class:`tagPARAMDESC`

.. class:: tagPARAMDESC

    .. attribute:: pparamdescex

        :class:`LPPARAMDESCEX`


    .. attribute:: wParamFlags

        :class:`USHORT`

_TMP_TYPEDESC_UNION
'''''''''''''''''''
.. class:: TMP_TYPEDESC_UNION

    Alias for :class:`_TMP_TYPEDESC_UNION`

.. class:: _TMP_TYPEDESC_UNION
...
.. class:: tagARRAYDESC
    ...
    .. attribute:: rgbounds
        ...
        :class:`SAFEARRAYBOUND` ``[<winstruct.ComplexArrayExpression object at 0x038F5390>]``

tagELEMDESC
'''''''''''
.. class:: ELEMDESC

    Alias for :class:`tagELEMDESC`

.. class:: LPELEMDESC

    Pointer to :class:`tagELEMDESC`
...
.. class:: LPFUNCDESC
    ...
    Pointer to :class:`tagFUNCDESC`

.. class:: FUNCDESC

    Alias for :class:`tagFUNCDESC`
...
.. class:: tagFUNCDESC
    ...
    .. attribute:: elemdescFunc

        :class:`ELEMDESC`


    .. attribute:: wFuncFlags

        :class:`WORD`

_TMP_VARDESC_UNION
''''''''''''''''''
.. class:: TMP_VARDESC_UNION

    Alias for :class:`_TMP_VARDESC_UNION`

.. class:: _TMP_VARDESC_UNION
...
.. class:: LPVARDESC
    ...
    Pointer to :class:`tagVARDESC`

.. class:: VARDESC

    Alias for :class:`tagVARDESC`
...
.. class:: LPBINDPTR
    ...
    Pointer to :class:`tagBINDPTR`

.. class:: BINDPTR

    Alias for :class:`tagBINDPTR`

.. class:: tagBINDPTR

    .. attribute:: lpfuncdesc
...
.. class:: IDLDESC
    ...
    Alias for :class:`tagIDLDESC`

.. class:: LPIDLDESC

    Pointer to :class:`tagIDLDESC`
...
.. class:: LPTLIBATTR
    ...
    Pointer to :class:`tagTLIBATTR`

.. class:: TLIBATTR

    Alias for :class:`tagTLIBATTR`
...
.. class:: tagTLIBATTR
    ...
    .. attribute:: wMajorVerNum

        :class:`WORD`


    .. attribute:: wMinorVerNum
...
.. class:: TYPEATTR
    ...
    Alias for :class:`tagTYPEATTR`

.. class:: LPTYPEATTR

    Pointer to :class:`tagTYPEATTR`
...
.. class:: tagTYPEATTR
    ...
    .. attribute:: memidConstructor

        :class:`MEMBERID`


    .. attribute:: memidDestructor
    ...
    .. attribute:: cbAlignment

        :class:`WORD`


    .. attribute:: wTypeFlags
    ...
    .. attribute:: tdescAlias

        :class:`TYPEDESC`


    .. attribute:: idldescType
...
''''''''''''''''''''''''''
.. class:: CERT_ISSUER_SERIAL_NUMBER

    Alias for :class:`_CERT_ISSUER_SERIAL_NUMBER`

.. class:: PCERT_ISSUER_SERIAL_NUMBER

    Pointer to :class:`_CERT_ISSUER_SERIAL_NUMBER`
...
_TMPUNION_CERT_ID
'''''''''''''''''
.. class:: TMPUNION_CERT_ID

    Alias for :class:`_TMPUNION_CERT_ID`

.. class:: _TMPUNION_CERT_ID

    .. attribute:: IssuerSerialNumber
...
.. class:: CERT_ID
    ...
    Alias for :class:`_CERT_ID`

.. class:: PCERT_ID

    Pointer to :class:`_CERT_ID`

.. class:: _CERT_ID

    .. attribute:: dwIdChoice
...
''''''''''''''''''''''''''''''''''''''''''''''
.. class:: TMPUNION_CMSG_MAIL_LIST_RECIPIENT_ENCODE_INFO

    Alias for :class:`_TMPUNION_CMSG_MAIL_LIST_RECIPIENT_ENCODE_INFO`

.. class:: _TMPUNION_CMSG_MAIL_LIST_RECIPIENT_ENCODE_INFO

    .. attribute:: hKeyEncryptionKey

        :class:`HCRYPTKEY`


    .. attribute:: pvKeyEncryptionKey

        :class:`PVOID`

_CMSG_MAIL_LIST_RECIPIENT_ENCODE_INFO
'''''''''''''''''''''''''''''''''''''
.. class:: PCMSG_MAIL_LIST_RECIPIENT_ENCODE_INFO

    Pointer to :class:`_CMSG_MAIL_LIST_RECIPIENT_ENCODE_INFO`

.. class:: CMSG_MAIL_LIST_RECIPIENT_ENCODE_INFO

    Alias for :class:`_CMSG_MAIL_LIST_RECIPIENT_ENCODE_INFO`
...
''''''''''''''''''''''''''''''''''''''''''''''
.. class:: TMPUNION_CMSG_KEY_AGREE_RECIPIENT_ENCODE_INFO

    Alias for :class:`_TMPUNION_CMSG_KEY_AGREE_RECIPIENT_ENCODE_INFO`

.. class:: _TMPUNION_CMSG_KEY_AGREE_RECIPIENT_ENCODE_INFO

    .. attribute:: pEphemeralAlgorithm
...
'''''''''''''''''''''''''''''''''''''''''
.. class:: PCMSG_RECIPIENT_ENCRYPTED_KEY_ENCODE_INFO

    Pointer to :class:`_CMSG_RECIPIENT_ENCRYPTED_KEY_ENCODE_INFO`

.. class:: CMSG_RECIPIENT_ENCRYPTED_KEY_ENCODE_INFO

    Alias for :class:`_CMSG_RECIPIENT_ENCRYPTED_KEY_ENCODE_INFO`
...
'''''''''''''''''''''''''''''''''''''
.. class:: PCMSG_KEY_AGREE_RECIPIENT_ENCODE_INFO

    Pointer to :class:`_CMSG_KEY_AGREE_RECIPIENT_ENCODE_INFO`

.. class:: CMSG_KEY_AGREE_RECIPIENT_ENCODE_INFO

    Alias for :class:`_CMSG_KEY_AGREE_RECIPIENT_ENCODE_INFO`
...
.. class:: _CMSG_KEY_AGREE_RECIPIENT_ENCODE_INFO
    ...
    .. attribute:: KeyWrapAlgorithm

        :class:`CRYPT_ALGORITHM_IDENTIFIER`


    .. attribute:: pvKeyWrapAuxInfo
    ...
    .. attribute:: UserKeyingMaterial

        :class:`CRYPT_DATA_BLOB`


    .. attribute:: cRecipientEncryptedKeys

        :class:`DWORD`


    .. attribute:: rgpRecipientEncryptedKeys

        :class:`PCMSG_RECIPIENT_ENCRYPTED_KEY_ENCODE_INFO`

_TMP_CMSG_RECIPIENT_ENCODE_INFO_UNION
'''''''''''''''''''''''''''''''''''''
.. class:: TMP_CMSG_RECIPIENT_ENCODE_INFO_UNION

    Alias for :class:`_TMP_CMSG_RECIPIENT_ENCODE_INFO_UNION`

.. class:: _TMP_CMSG_RECIPIENT_ENCODE_INFO_UNION
...
'''''''''''''''''''''''''''
.. class:: CMSG_RECIPIENT_ENCODE_INFO

    Alias for :class:`_CMSG_RECIPIENT_ENCODE_INFO`

.. class:: PCMSG_RECIPIENT_ENCODE_INFO

    Pointer to :class:`_CMSG_RECIPIENT_ENCODE_INFO`

.. class:: _CMSG_RECIPIENT_ENCODE_INFO

    .. attribute:: dwRecipientChoice
...
'''''''''''''''''''''''''''
.. class:: PCMSG_ENVELOPED_ENCODE_INFO

    Pointer to :class:`_CMSG_ENVELOPED_ENCODE_INFO`

.. class:: CMSG_ENVELOPED_ENCODE_INFO

    Alias for :class:`_CMSG_ENVELOPED_ENCODE_INFO`
...
.. class:: _CMSG_ENVELOPED_ENCODE_INFO
    ...
    .. attribute:: cRecipients

        :class:`DWORD`


    .. attribute:: rgpRecipients

        :class:`PCERT_INFO`


    .. attribute:: rgCmsRecipients

        :class:`PCMSG_RECIPIENT_ENCODE_INFO`


    .. attribute:: cCertEncoded

        :class:`DWORD`


    .. attribute:: rgCertEncoded

        :class:`PCERT_BLOB`


    .. attribute:: cCrlEncoded

        :class:`DWORD`


    .. attribute:: rgCrlEncoded

        :class:`PCRL_BLOB`


    .. attribute:: cAttrCertEncoded

        :class:`DWORD`


    .. attribute:: rgAttrCertEncoded

        :class:`PCERT_BLOB`


    .. attribute:: cUnprotectedAttr

        :class:`DWORD`


    .. attribute:: rgUnprotectedAttr

        :class:`PCRYPT_ATTRIBUTE`

_CMSG_STREAM_INFO
'''''''''''''''''
.. class:: CMSG_STREAM_INFO

    Alias for :class:`_CMSG_STREAM_INFO`

.. class:: PCMSG_STREAM_INFO

    Pointer to :class:`_CMSG_STREAM_INFO`
...
''''''''''''''''''''''''''''''''
.. class:: TMPUNION_CMSG_CTRL_DECRYPT_PARA

    Alias for :class:`_TMPUNION_CMSG_CTRL_DECRYPT_PARA`

.. class:: _TMPUNION_CMSG_CTRL_DECRYPT_PARA
    ...
    .. attribute:: hNCryptKey

        :class:`NCRYPT_KEY_HANDLE`

_CMSG_CTRL_DECRYPT_PARA
'''''''''''''''''''''''
.. class:: PCMSG_CTRL_DECRYPT_PARA

    Pointer to :class:`_CMSG_CTRL_DECRYPT_PARA`

.. class:: CMSG_CTRL_DECRYPT_PARA

    Alias for :class:`_CMSG_CTRL_DECRYPT_PARA`
...
.. class:: _CMSG_CTRL_DECRYPT_PARA
    ...
    .. attribute:: dwRecipientIndex

        :class:`DWORD`

_SPC_PE_IMAGE_DATA
''''''''''''''''''
.. class:: PSPC_PE_IMAGE_DATA

    Pointer to :class:`_SPC_PE_IMAGE_DATA`

.. class:: SPC_PE_IMAGE_DATA

    Alias for :class:`_SPC_PE_IMAGE_DATA`
...
''''''''''''''''''''''''''
.. class:: PSPC_INDIRECT_DATA_CONTENT

    Pointer to :class:`_SPC_INDIRECT_DATA_CONTENT`

.. class:: SPC_INDIRECT_DATA_CONTENT

    Alias for :class:`_SPC_INDIRECT_DATA_CONTENT`
...
.. class:: _EVT_VARIANT
    ...
    .. attribute:: anon_01
        ...
        :class:`_ANON__EVT_VARIANT_SUB_UNION_1`
...
.. class:: EVT_RPC_LOGIN
    ...
    Alias for :class:`_EVT_RPC_LOGIN`

.. class:: _EVT_RPC_LOGIN
...
.. class:: _FILE_NAME_INFORMATION
    ...
    .. attribute:: FileName
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x0393A0F0>]``
...
.. class:: FILE_STREAM_INFORMATION
    ...
    Alias for :class:`_FILE_STREAM_INFORMATION`

.. class:: PFILE_STREAM_INFORMATION

    Pointer to :class:`_FILE_STREAM_INFORMATION`

.. class:: _FILE_STREAM_INFORMATION
    ...
    .. attribute:: StreamNameLength

        :class:`ULONG`


    .. attribute:: StreamSize

        :class:`LARGE_INTEGER`


    .. attribute:: StreamAllocationSize
    ...
    .. attribute:: StreamName
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x0393A890>]``
...
.. class:: FILE_FULL_EA_INFORMATION
    ...
    Alias for :class:`_FILE_FULL_EA_INFORMATION`

.. class:: PFILE_FULL_EA_INFORMATION

    Pointer to :class:`_FILE_FULL_EA_INFORMATION`

.. class:: _FILE_FULL_EA_INFORMATION
    ...
    .. attribute:: EaNameLength

        :class:`BYTE`


    .. attribute:: EaValueLength
    ...
    .. attribute:: EaName
        ...
        :class:`CHAR` ``[<winstruct.ComplexArrayExpression object at 0x0393AB30>]``

_FILE_GET_EA_INFORMATION
''''''''''''''''''''''''
.. class:: FILE_GET_EA_INFORMATION

    Alias for :class:`_FILE_GET_EA_INFORMATION`

.. class:: PFILE_GET_EA_INFORMATION

    Pointer to :class:`_FILE_GET_EA_INFORMATION`

.. class:: _FILE_GET_EA_INFORMATION
    ...
    .. attribute:: EaName
        ...
        :class:`CHAR` ``[<winstruct.ComplexArrayExpression object at 0x0393AC70>]``

tagVS_FIXEDFILEINFO
'''''''''''''''''''
.. class:: VS_FIXEDFILEINFO

    Alias for :class:`tagVS_FIXEDFILEINFO`

.. class:: tagVS_FIXEDFILEINFO

    .. attribute:: dwSignature

        :class:`DWORD`


    .. attribute:: dwStrucVersion

        :class:`DWORD`


    .. attribute:: dwFileVersionMS

        :class:`DWORD`


    .. attribute:: dwFileVersionLS

        :class:`DWORD`


    .. attribute:: dwProductVersionMS

        :class:`DWORD`


    .. attribute:: dwProductVersionLS

        :class:`DWORD`


    .. attribute:: dwFileFlagsMask

        :class:`DWORD`


    .. attribute:: dwFileFlags
    ...
    .. attribute:: dwFileSubtype

        :class:`DWORD`


    .. attribute:: dwFileDateMS

        :class:`DWORD`


    .. attribute:: dwFileDateLS

        :class:`DWORD`

_FILE_LINK_INFORMATION
''''''''''''''''''''''
.. class:: PFILE_LINK_INFORMATION

    Pointer to :class:`_FILE_LINK_INFORMATION`

.. class:: FILE_LINK_INFORMATION

    Alias for :class:`_FILE_LINK_INFORMATION`

.. class:: _FILE_LINK_INFORMATION

    .. attribute:: anon_01

        :class:`_ANON__FILE_LINK_INFORMATION_SUB_UNION_1`
    ...
    .. attribute:: FileName
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03940250>]``

_WIN32_FIND_DATAA
'''''''''''''''''
.. class:: LPWIN32_FIND_DATAA

    Pointer to :class:`_WIN32_FIND_DATAA`

.. class:: PWIN32_FIND_DATAA

    Pointer to :class:`_WIN32_FIND_DATAA`

.. class:: WIN32_FIND_DATAA

    Alias for :class:`_WIN32_FIND_DATAA`
...
.. class:: _WIN32_FIND_DATAA
    ...
    .. attribute:: cFileName
        ...
        :class:`CHAR` ``[<winstruct.ComplexArrayExpression object at 0x03940570>]``


    .. attribute:: cAlternateFileName

        :class:`CHAR` ``[<winstruct.ComplexArrayExpression object at 0x039405F0>]``
    ...
    .. attribute:: dwCreatorType

        :class:`DWORD`


    .. attribute:: wFinderFlags

        :class:`WORD`

_WIN32_FIND_DATAW
'''''''''''''''''
.. class:: PWIN32_FIND_DATAW

    Pointer to :class:`_WIN32_FIND_DATAW`

.. class:: WIN32_FIND_DATAW

    Alias for :class:`_WIN32_FIND_DATAW`

.. class:: LPWIN32_FIND_DATAW
...
.. class:: _WIN32_FIND_DATAW
    ...
    .. attribute:: cFileName
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x039409F0>]``


    .. attribute:: cAlternateFileName

        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03940A70>]``
...
.. class:: _GUID
    ...
    .. attribute:: Data4
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x03940D50>]``

_LSA_OBJECT_ATTRIBUTES
''''''''''''''''''''''
.. class:: PLSA_OBJECT_ATTRIBUTES

    Pointer to :class:`_LSA_OBJECT_ATTRIBUTES`

.. class:: LSA_OBJECT_ATTRIBUTES

    Alias for :class:`_LSA_OBJECT_ATTRIBUTES`
...
''''''''''''''''''''''''''''
.. class:: POLICY_LSA_SERVER_ROLE_INFO

    Alias for :class:`_POLICY_LSA_SERVER_ROLE_INFO`

.. class:: PPOLICY_LSA_SERVER_ROLE_INFO

    Pointer to :class:`_POLICY_LSA_SERVER_ROLE_INFO`

.. class:: _POLICY_LSA_SERVER_ROLE_INFO

    .. attribute:: LsaServerRole

        :class:`POLICY_LSA_SERVER_ROLE`

_POLICY_ACCOUNT_DOMAIN_INFO
'''''''''''''''''''''''''''
.. class:: POLICY_ACCOUNT_DOMAIN_INFO

    Alias for :class:`_POLICY_ACCOUNT_DOMAIN_INFO`

.. class:: PPOLICY_ACCOUNT_DOMAIN_INFO

    Pointer to :class:`_POLICY_ACCOUNT_DOMAIN_INFO`

.. class:: _POLICY_ACCOUNT_DOMAIN_INFO
...
.. class:: LSA_TRANSLATED_SID
    ...
    Alias for :class:`_LSA_TRANSLATED_SID`

.. class:: PLSA_TRANSLATED_SID

    Pointer to :class:`_LSA_TRANSLATED_SID`

.. class:: _LSA_TRANSLATED_SID
    ...
    .. attribute:: RelativeId

        :class:`ULONG`


    .. attribute:: DomainIndex

        :class:`LONG`

_LSA_TRANSLATED_SID2
''''''''''''''''''''
.. class:: PLSA_TRANSLATED_SID2

    Pointer to :class:`_LSA_TRANSLATED_SID2`

.. class:: LSA_TRANSLATED_SID2

    Alias for :class:`_LSA_TRANSLATED_SID2`

.. class:: _LSA_TRANSLATED_SID2
...
''''''''''''''''''''
.. class:: LSA_TRANSLATED_NAME

    Alias for :class:`_LSA_TRANSLATED_NAME`

.. class:: PLSA_TRANSLATED_NAME

    Pointer to :class:`_LSA_TRANSLATED_NAME`

.. class:: _LSA_TRANSLATED_NAME
...
''''''''''''''''''''''
.. class:: LSA_TRUST_INFORMATION

    Alias for :class:`_LSA_TRUST_INFORMATION`

.. class:: PLSA_TRUST_INFORMATION

    Pointer to :class:`_LSA_TRUST_INFORMATION`
...
'''''''''''''''''''''''''''
.. class:: LSA_REFERENCED_DOMAIN_LIST

    Alias for :class:`_LSA_REFERENCED_DOMAIN_LIST`

.. class:: PLSA_REFERENCED_DOMAIN_LIST

    Pointer to :class:`_LSA_REFERENCED_DOMAIN_LIST`

.. class:: _LSA_REFERENCED_DOMAIN_LIST
...
.. class:: IP6_ADDRESS
    ...
    .. attribute:: IP6Qword
        ...
        :class:`ULONGLONG` ``[<winstruct.ComplexArrayExpression object at 0x0394A410>]``
...
.. class:: _MIB_IPADDRTABLE
    ...
    .. attribute:: table
        ...
        :class:`MIB_IPADDRROW` ``[<winstruct.ComplexArrayExpression object at 0x0394FEF0>]``
...
.. class:: _MIB_IFROW
    ...
    .. attribute:: wszName
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x0394FFF0>]``
    ...
    .. attribute:: bPhysAddr
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x0395B250>]``
    ...
    .. attribute:: bDescr
        ...
        :class:`UCHAR` ``[<winstruct.ComplexArrayExpression object at 0x0395B770>]``
...
.. class:: _MIB_IFTABLE
    ...
    .. attribute:: table
        ...
        :class:`MIB_IFROW` ``[<winstruct.ComplexArrayExpression object at 0x0395B8D0>]``
...
.. class:: _MIB_TCPTABLE_OWNER_PID
    ...
    .. attribute:: table
        ...
        :class:`MIB_TCPROW_OWNER_PID` ``[<winstruct.ComplexArrayExpression object at 0x0395BC30>]``
...
.. class:: _MIB_UDPTABLE_OWNER_PID
    ...
    .. attribute:: table
        ...
        :class:`MIB_UDPROW_OWNER_PID` ``[<winstruct.ComplexArrayExpression object at 0x0395BE90>]``
...
.. class:: _MIB_UDP6ROW_OWNER_PID
    ...
    .. attribute:: ucLocalAddr
        ...
        :class:`UCHAR` ``[<winstruct.ComplexArrayExpression object at 0x0395BF70>]``
...
.. class:: _MIB_UDP6TABLE_OWNER_PID
    ...
    .. attribute:: table
        ...
        :class:`MIB_UDP6ROW_OWNER_PID` ``[<winstruct.ComplexArrayExpression object at 0x03960170>]``
...
.. class:: _MIB_TCP6ROW_OWNER_PID
    ...
    .. attribute:: ucLocalAddr
        ...
        :class:`UCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03960250>]``
    ...
    .. attribute:: ucRemoteAddr
        ...
        :class:`UCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03960350>]``
...
.. class:: _MIB_TCP6TABLE_OWNER_PID
    ...
    .. attribute:: table
        ...
        :class:`MIB_TCP6ROW_OWNER_PID` ``[<winstruct.ComplexArrayExpression object at 0x03960570>]``
...
.. class:: _IP_ADAPTER_INDEX_MAP
    ...
    .. attribute:: Name
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x039608D0>]``
...
.. class:: _IP_INTERFACE_INFO
    ...
    .. attribute:: Adapter
        ...
        :class:`IP_ADAPTER_INDEX_MAP` ``[<winstruct.ComplexArrayExpression object at 0x039609F0>]``
...
.. class:: DNS_TXT_DATAW
    ...
    .. attribute:: pStringArray
        ...
        :class:`PWSTR` ``[<winstruct.ComplexArrayExpression object at 0x03964810>]``
...
.. class:: DNS_TXT_DATAA
    ...
    .. attribute:: pStringArray
        ...
        :class:`PSTR` ``[<winstruct.ComplexArrayExpression object at 0x039648F0>]``
...
.. class:: DNS_NULL_DATA
    ...
    .. attribute:: Data
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x03964A30>]``
...
.. class:: DNS_WKS_DATA
    ...
    .. attribute:: BitMask
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x03964BB0>]``
...
.. class:: DNS_SIG_DATAW
    ...
    .. attribute:: Signature
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x03964F90>]``
...
.. class:: DNS_SIG_DATAA
    ...
    .. attribute:: Signature
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x0396A330>]``
...
.. class:: DNS_KEY_DATA
    ...
    .. attribute:: Key
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x0396A5F0>]``
...
.. class:: DNS_DHCID_DATA
    ...
    .. attribute:: DHCID
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x0396A730>]``
...
.. class:: DNS_NSEC_DATAW
    ...
    .. attribute:: TypeBitMaps
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x0396A8B0>]``
...
.. class:: DNS_NSEC_DATAA
    ...
    .. attribute:: TypeBitMaps
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x0396AA50>]``
...
.. class:: DNS_NSEC3_DATA
    ...
    .. attribute:: chData
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x0396AD50>]``
...
.. class:: DNS_NSEC3PARAM_DATA
    ...
    .. attribute:: bPad
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x0396AF90>]``


    .. attribute:: pbSalt

        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x0396D030>]``
...
.. class:: DNS_DS_DATA
    ...
    .. attribute:: Digest
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x0396D290>]``
...
.. class:: DNS_OPT_DATA
    ...
    .. attribute:: Data
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x0396D430>]``
...
.. class:: DNS_NXT_DATAW
    ...
    .. attribute:: wTypes
        ...
        :class:`WORD` ``[<winstruct.ComplexArrayExpression object at 0x0396D890>]``
...
.. class:: DNS_NXT_DATAA
    ...
    .. attribute:: wTypes
        ...
        :class:`WORD` ``[<winstruct.ComplexArrayExpression object at 0x0396DA10>]``
...
.. class:: DNS_ATMA_DATA
    ...
    .. attribute:: Address
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x03B873D0>]``
...
.. class:: DNS_WINS_DATA
    ...
    .. attribute:: WinsServers
        ...
        :class:`IP4_ADDRESS` ``[<winstruct.ComplexArrayExpression object at 0x03B8B510>]``
...
.. class:: DNS_TLSA_DATA
    ...
    .. attribute:: bPad
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x03B8B9B0>]``


    .. attribute:: bCertificateAssociationData

        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x03B8B9F0>]``
...
.. class:: DNS_UNKNOWN_DATA
    ...
    .. attribute:: bData
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x03B8BB30>]``
...
.. class:: _KEY_VALUE_BASIC_INFORMATION
    ...
    .. attribute:: Name
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03B9A730>]``
...
.. class:: _KEY_VALUE_FULL_INFORMATION
    ...
    .. attribute:: Name
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03B9A9D0>]``
...
.. class:: _KEY_VALUE_PARTIAL_INFORMATION
    ...
    .. attribute:: Data
        ...
        :class:`UCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03B9ABB0>]``
...
'''''''''''''''''''''''''
.. class:: PACL_REVISION_INFORMATION

    Pointer to :class:`_ACL_REVISION_INFORMATION`

.. class:: ACL_REVISION_INFORMATION

    Alias for :class:`_ACL_REVISION_INFORMATION`
...
'''''''''''''''''''''
.. class:: PACL_SIZE_INFORMATION

    Pointer to :class:`_ACL_SIZE_INFORMATION`

.. class:: ACL_SIZE_INFORMATION

    Alias for :class:`_ACL_SIZE_INFORMATION`
...
.. class:: _ACL_SIZE_INFORMATION
    ...
    .. attribute:: AclBytesInUse

        :class:`DWORD`


    .. attribute:: AclBytesFree
...
.. class:: ACCESS_DENIED_CALLBACK_OBJECT_ACE
    ...
    Alias for :class:`_ACCESS_DENIED_CALLBACK_OBJECT_ACE`

.. class:: PACCESS_DENIED_CALLBACK_OBJECT_ACE

    Pointer to :class:`_ACCESS_DENIED_CALLBACK_OBJECT_ACE`
...
.. class:: SYSTEM_AUDIT_ACE
    ...
    Alias for :class:`_SYSTEM_AUDIT_ACE`
...
.. class:: SYSTEM_ALARM_ACE
    ...
    Alias for :class:`_SYSTEM_ALARM_ACE`
...
''''''''''''''''''''''''''''''
.. class:: PSYSTEM_RESOURCE_ATTRIBUTE_ACE

    Pointer to :class:`_SYSTEM_RESOURCE_ATTRIBUTE_ACE`

.. class:: SYSTEM_RESOURCE_ATTRIBUTE_ACE

    Alias for :class:`_SYSTEM_RESOURCE_ATTRIBUTE_ACE`

.. class:: _SYSTEM_RESOURCE_ATTRIBUTE_ACE
...
.. class:: SYSTEM_SCOPED_POLICY_ID_ACE
    ...
    Alias for :class:`_SYSTEM_SCOPED_POLICY_ID_ACE`

.. class:: PSYSTEM_SCOPED_POLICY_ID_ACE

    Pointer to :class:`_SYSTEM_SCOPED_POLICY_ID_ACE`

.. class:: _SYSTEM_SCOPED_POLICY_ID_ACE
...
'''''''''''''''''''''''''''''''
.. class:: PSYSTEM_PROCESS_TRUST_LABEL_ACE

    Pointer to :class:`_SYSTEM_PROCESS_TRUST_LABEL_ACE`

.. class:: SYSTEM_PROCESS_TRUST_LABEL_ACE

    Alias for :class:`_SYSTEM_PROCESS_TRUST_LABEL_ACE`

.. class:: _SYSTEM_PROCESS_TRUST_LABEL_ACE
...
.. class:: SYSTEM_AUDIT_OBJECT_ACE
    ...
    Alias for :class:`_SYSTEM_AUDIT_OBJECT_ACE`

.. class:: PSYSTEM_AUDIT_OBJECT_ACE

    Pointer to :class:`_SYSTEM_AUDIT_OBJECT_ACE`
...
''''''''''''''''''''''''
.. class:: SYSTEM_ALARM_OBJECT_ACE

    Alias for :class:`_SYSTEM_ALARM_OBJECT_ACE`

.. class:: PSYSTEM_ALARM_OBJECT_ACE

    Pointer to :class:`_SYSTEM_ALARM_OBJECT_ACE`
...
''''''''''''''''''''''''''
.. class:: PSYSTEM_AUDIT_CALLBACK_ACE

    Pointer to :class:`_SYSTEM_AUDIT_CALLBACK_ACE`

.. class:: SYSTEM_AUDIT_CALLBACK_ACE

    Alias for :class:`_SYSTEM_AUDIT_CALLBACK_ACE`
...
''''''''''''''''''''''''''
.. class:: SYSTEM_ALARM_CALLBACK_ACE

    Alias for :class:`_SYSTEM_ALARM_CALLBACK_ACE`

.. class:: PSYSTEM_ALARM_CALLBACK_ACE

    Pointer to :class:`_SYSTEM_ALARM_CALLBACK_ACE`
...
'''''''''''''''''''''''''''''''''
.. class:: PSYSTEM_AUDIT_CALLBACK_OBJECT_ACE

    Pointer to :class:`_SYSTEM_AUDIT_CALLBACK_OBJECT_ACE`

.. class:: SYSTEM_AUDIT_CALLBACK_OBJECT_ACE

    Alias for :class:`_SYSTEM_AUDIT_CALLBACK_OBJECT_ACE`
...
'''''''''''''''''''''''''''''''''
.. class:: PSYSTEM_ALARM_CALLBACK_OBJECT_ACE

    Pointer to :class:`_SYSTEM_ALARM_CALLBACK_OBJECT_ACE`

.. class:: SYSTEM_ALARM_CALLBACK_OBJECT_ACE

    Alias for :class:`_SYSTEM_ALARM_CALLBACK_OBJECT_ACE`
...
'''''''''''''''''''''''''''''''''''''''''''
.. class:: CLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1_UNION

    Alias for :class:`_CLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1_UNION`

.. class:: _CLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1_UNION

    .. attribute:: pInt64

        :class:`DWORD` ``[<winstruct.ComplexArrayExpression object at 0x03BA46D0>]``


    .. attribute:: pUint64

        :class:`DWORD` ``[<winstruct.ComplexArrayExpression object at 0x03BA4750>]``


    .. attribute:: ppString

        :class:`DWORD` ``[<winstruct.ComplexArrayExpression object at 0x03BA47D0>]``


    .. attribute:: pFqbn

        :class:`DWORD` ``[<winstruct.ComplexArrayExpression object at 0x03BA4850>]``


    .. attribute:: pOctetString

        :class:`DWORD` ``[<winstruct.ComplexArrayExpression object at 0x03BA48B0>]``

_CLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1
'''''''''''''''''''''''''''''''''''''
.. class:: PCLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1

    Pointer to :class:`_CLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1`

.. class:: CLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1

    Alias for :class:`_CLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1`

.. class:: _CLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1
...
''''''''''''''''''''''''''''''''''''
.. class:: PCLAIM_SECURITY_ATTRIBUTE_FQBN_VALUE

    Pointer to :class:`_CLAIM_SECURITY_ATTRIBUTE_FQBN_VALUE`

.. class:: CLAIM_SECURITY_ATTRIBUTE_FQBN_VALUE

    Alias for :class:`_CLAIM_SECURITY_ATTRIBUTE_FQBN_VALUE`

.. class:: _CLAIM_SECURITY_ATTRIBUTE_FQBN_VALUE
...
''''''''''''''''''''''''''''''''''''''''''''
.. class:: PCLAIM_SECURITY_ATTRIBUTE_OCTET_STRING_VALUE

    Pointer to :class:`_CLAIM_SECURITY_ATTRIBUTE_OCTET_STRING_VALUE`

.. class:: CLAIM_SECURITY_ATTRIBUTE_OCTET_STRING_VALUE

    Alias for :class:`_CLAIM_SECURITY_ATTRIBUTE_OCTET_STRING_VALUE`
...
'''''''''''''''''''''''''''''''''''''''''''''''
.. class:: PCLAIM_SECURITY_ATTRIBUTE_OCTET_STRING_RELATIVE

    Pointer to :class:`_CLAIM_SECURITY_ATTRIBUTE_OCTET_STRING_RELATIVE`

.. class:: CLAIM_SECURITY_ATTRIBUTE_OCTET_STRING_RELATIVE

    Alias for :class:`_CLAIM_SECURITY_ATTRIBUTE_OCTET_STRING_RELATIVE`

.. class:: _CLAIM_SECURITY_ATTRIBUTE_OCTET_STRING_RELATIVE
    ...
    .. attribute:: OctetString
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x03BA4E10>]``

_CLAIM_SECURITY_ATTRIBUTE_V1_UNION
''''''''''''''''''''''''''''''''''
.. class:: CLAIM_SECURITY_ATTRIBUTE_V1_UNION

    Alias for :class:`_CLAIM_SECURITY_ATTRIBUTE_V1_UNION`

.. class:: _CLAIM_SECURITY_ATTRIBUTE_V1_UNION
...
''''''''''''''''''''''''''''
.. class:: CLAIM_SECURITY_ATTRIBUTE_V1

    Alias for :class:`_CLAIM_SECURITY_ATTRIBUTE_V1`

.. class:: PCLAIM_SECURITY_ATTRIBUTE_V1

    Pointer to :class:`_CLAIM_SECURITY_ATTRIBUTE_V1`

.. class:: _CLAIM_SECURITY_ATTRIBUTE_V1
...
''''''''''''''''''''''''''''''''''''''''''''
.. class:: CLAIM_SECURITY_ATTRIBUTES_INFORMATION_UNION

    Alias for :class:`_CLAIM_SECURITY_ATTRIBUTES_INFORMATION_UNION`

.. class:: _CLAIM_SECURITY_ATTRIBUTES_INFORMATION_UNION
...
''''''''''''''''''''''''''''''''''''''
.. class:: CLAIM_SECURITY_ATTRIBUTES_INFORMATION

    Alias for :class:`_CLAIM_SECURITY_ATTRIBUTES_INFORMATION`

.. class:: PCLAIM_SECURITY_ATTRIBUTES_INFORMATION

    Pointer to :class:`_CLAIM_SECURITY_ATTRIBUTES_INFORMATION`

.. class:: _CLAIM_SECURITY_ATTRIBUTES_INFORMATION
...
''''''''''''''''''''
.. class:: PISECURITY_DESCRIPTOR

    Pointer to :class:`_SECURITY_DESCRIPTOR`

.. class:: SECURITY_DESCRIPTOR

    Alias for :class:`_SECURITY_DESCRIPTOR`
...
_GENERIC_MAPPING
''''''''''''''''
.. class:: PGENERIC_MAPPING

    Pointer to :class:`_GENERIC_MAPPING`

.. class:: GENERIC_MAPPING

    Alias for :class:`_GENERIC_MAPPING`

.. class:: _GENERIC_MAPPING

    .. attribute:: GenericRead
...
.. class:: PRIVILEGE_SET
    ...
    Alias for :class:`_PRIVILEGE_SET`

.. class:: PPRIVILEGE_SET

    Pointer to :class:`_PRIVILEGE_SET`
...
.. class:: _PRIVILEGE_SET
    ...
    .. attribute:: Privilege
        ...
        :class:`LUID_AND_ATTRIBUTES` ``[<winstruct.ComplexArrayExpression object at 0x03BA8990>]``

_OBJECTS_AND_NAME_A
'''''''''''''''''''
.. class:: OBJECTS_AND_NAME_A

    Alias for :class:`_OBJECTS_AND_NAME_A`

.. class:: POBJECTS_AND_NAME_A

    Pointer to :class:`_OBJECTS_AND_NAME_A`

.. class:: _OBJECTS_AND_NAME_A

    .. attribute:: ObjectsPresent
    ...
    .. attribute:: InheritedObjectTypeName
...
_OBJECTS_AND_SID
''''''''''''''''
.. class:: POBJECTS_AND_SID

    Pointer to :class:`_OBJECTS_AND_SID`

.. class:: OBJECTS_AND_SID

    Alias for :class:`_OBJECTS_AND_SID`

.. class:: _OBJECTS_AND_SID
    ...
    .. attribute:: ObjectTypeGuid

        :class:`GUID`


    .. attribute:: InheritedObjectTypeGuid
...
.. class:: PTRUSTEEA
    ...
    Pointer to :class:`_TRUSTEE_A`

.. class:: TRUSTEEA

    Alias for :class:`_TRUSTEE_A`
...
.. class:: _TRUSTEE_A
    ...
    .. attribute:: pMultipleTrustee

        :class:`_TRUSTEE_A`


    .. attribute:: MultipleTrusteeOperation

        :class:`MULTIPLE_TRUSTEE_OPERATION`


    .. attribute:: TrusteeForm

        :class:`TRUSTEE_FORM`


    .. attribute:: TrusteeType
    ...
    .. attribute:: anon_01
        ...
        :class:`_ANON__TRUSTEE_A_SUB_UNION_1`
...
_OBJECTS_AND_NAME_W
'''''''''''''''''''
.. class:: OBJECTS_AND_NAME_W

    Alias for :class:`_OBJECTS_AND_NAME_W`

.. class:: POBJECTS_AND_NAME_W

    Pointer to :class:`_OBJECTS_AND_NAME_W`
...
.. class:: PTRUSTEE_W
    ...
    Pointer to :class:`_TRUSTEE_W`

.. class:: TRUSTEE_W

    Alias for :class:`_TRUSTEE_W`
...
.. class:: _TRUSTEE_W
    ...
    .. attribute:: anon_01
        ...
        :class:`_ANON__TRUSTEE_W_SUB_UNION_1`
...
_EXPLICIT_ACCESS_W
''''''''''''''''''
.. class:: EXPLICIT_ACCESSW

    Alias for :class:`_EXPLICIT_ACCESS_W`

.. class:: PEXPLICIT_ACCESSW

    Pointer to :class:`_EXPLICIT_ACCESS_W`

.. class:: PEXPLICIT_ACCESS_W
...
.. class:: _EXPLICIT_ACCESS_W
    ...
    .. attribute:: grfAccessPermissions

        :class:`DWORD`


    .. attribute:: grfAccessMode

        :class:`ACCESS_MODE`


    .. attribute:: grfInheritance
...
.. class:: _SHITEMID
    ...
    .. attribute:: abID
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x03BB2B10>]``
...
.. class:: _IMAGEHLP_MODULE64
    ...
    .. attribute:: ModuleName
        ...
        :class:`CHAR` ``[<winstruct.ComplexArrayExpression object at 0x03BB8710>]``


    .. attribute:: ImageName

        :class:`CHAR` ``[<winstruct.ComplexArrayExpression object at 0x03BB8790>]``


    .. attribute:: LoadedImageName

        :class:`CHAR` ``[<winstruct.ComplexArrayExpression object at 0x03BB87F0>]``


    .. attribute:: LoadedPdbName

        :class:`CHAR` ``[<winstruct.ComplexArrayExpression object at 0x03BB8850>]``
    ...
    .. attribute:: CVData
        ...
        :class:`CHAR` ``[<winstruct.ComplexArrayExpression object at 0x03BB8930>]``
...
.. class:: _IMAGEHLP_MODULEW64
    ...
    .. attribute:: ModuleName
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03BB8FB0>]``


    .. attribute:: ImageName

        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03BBD050>]``


    .. attribute:: LoadedImageName

        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03BBD0B0>]``


    .. attribute:: LoadedPdbName

        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03BBD110>]``
    ...
    .. attribute:: CVData
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03BBD210>]``
...
.. class:: _SYMBOL_INFO
    ...
    .. attribute:: Reserved
        ...
        :class:`ULONG64` ``[<winstruct.ComplexArrayExpression object at 0x03BBD7B0>]``
    ...
    .. attribute:: Name
        ...
        :class:`CHAR` ``[<winstruct.ComplexArrayExpression object at 0x03BBDC50>]``
...
.. class:: _SYMBOL_INFOW
    ...
    .. attribute:: Reserved
        ...
        :class:`ULONG64` ``[<winstruct.ComplexArrayExpression object at 0x03BBDDB0>]``
    ...
    .. attribute:: Name
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03BC1270>]``
...
.. class:: SYMSRV_INDEX_INFOW
    ...
    .. attribute:: file
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03BC1370>]``
    ...
    .. attribute:: dbgfile
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03BC1530>]``


    .. attribute:: pdbfile

        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03BC15D0>]``
...
.. class:: SYMSRV_INDEX_INFO
    ...
    .. attribute:: file
        ...
        :class:`CHAR` ``[<winstruct.ComplexArrayExpression object at 0x03BC17D0>]``
    ...
    .. attribute:: dbgfile
        ...
        :class:`CHAR` ``[<winstruct.ComplexArrayExpression object at 0x03BC1990>]``


    .. attribute:: pdbfile

        :class:`CHAR` ``[<winstruct.ComplexArrayExpression object at 0x03BC1A30>]``
...
.. class:: _IMAGEHLP_SYMBOL
    ...
    .. attribute:: Name
        ...
        :class:`CHAR` ``[<winstruct.ComplexArrayExpression object at 0x03BC1D90>]``
...
.. class:: _IMAGEHLP_SYMBOL64
    ...
    .. attribute:: Name
        ...
        :class:`CHAR` ``[<winstruct.ComplexArrayExpression object at 0x03BC1FF0>]``
...
.. class:: _IMAGEHLP_SYMBOLW64
    ...
    .. attribute:: Name
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03BC7270>]``
...
.. class:: _IMAGEHLP_STACK_FRAME
    ...
    .. attribute:: Params
        ...
        :class:`ULONG64` ``[<winstruct.ComplexArrayExpression object at 0x03BC74F0>]``


    .. attribute:: Reserved

        :class:`ULONG64` ``[<winstruct.ComplexArrayExpression object at 0x03BC7550>]``
...
.. class:: _IMAGEHLP_DEFERRED_SYMBOL_LOAD
    ...
    .. attribute:: FileName
        ...
        :class:`CHAR` ``[<winstruct.ComplexArrayExpression object at 0x03BC7DF0>]``
...
.. class:: _IMAGEHLP_DEFERRED_SYMBOL_LOAD64
    ...
    .. attribute:: FileName
        ...
        :class:`CHAR` ``[<winstruct.ComplexArrayExpression object at 0x03BCD0F0>]``
...
.. class:: _IMAGEHLP_DEFERRED_SYMBOL_LOADW64
    ...
    .. attribute:: FileName
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03BCD430>]``
...
.. class:: _KDHELP
    ...
    .. attribute:: Reserved
        ...
        :class:`DWORD` ``[<winstruct.ComplexArrayExpression object at 0x03BCDF10>]``
...
.. class:: _KDHELP64
    ...
    .. attribute:: Reserved0
        ...
        :class:`DWORD64` ``[<winstruct.ComplexArrayExpression object at 0x03BD04B0>]``
...
.. class:: _tagSTACKFRAME
    ...
    .. attribute:: Params
        ...
        :class:`DWORD` ``[<winstruct.ComplexArrayExpression object at 0x03BD0790>]``
    ...
    .. attribute:: Reserved
        ...
        :class:`DWORD` ``[<winstruct.ComplexArrayExpression object at 0x03BD0890>]``
...
.. class:: _tagSTACKFRAME64
    ...
    .. attribute:: Params
        ...
        :class:`DWORD64` ``[<winstruct.ComplexArrayExpression object at 0x03BD0C70>]``
    ...
    .. attribute:: Reserved
        ...
        :class:`DWORD64` ``[<winstruct.ComplexArrayExpression object at 0x03BD0D70>]``
...
.. class:: _tagSTACKFRAME_EX
    ...
    .. attribute:: Params
        ...
        :class:`DWORD64` ``[<winstruct.ComplexArrayExpression object at 0x03BD40F0>]``
    ...
    .. attribute:: Reserved
        ...
        :class:`DWORD64` ``[<winstruct.ComplexArrayExpression object at 0x03BD41F0>]``
...
.. class:: LPTIME_ZONE_INFORMATION
    ...
    Pointer to :class:`_TIME_ZONE_INFORMATION`

.. class:: PTIME_ZONE_INFORMATION

    Pointer to :class:`_TIME_ZONE_INFORMATION`

.. class:: TIME_ZONE_INFORMATION

    Alias for :class:`_TIME_ZONE_INFORMATION`
...
.. class:: _TIME_ZONE_INFORMATION
    ...
    .. attribute:: StandardName
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03BD4550>]``
    ...
    .. attribute:: DaylightName
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03BD4630>]``
...
.. class:: _TOKEN_PRIVILEGES
    ...
    .. attribute:: Privileges
        ...
        :class:`LUID_AND_ATTRIBUTES` ``[<winstruct.ComplexArrayExpression object at 0x03BD48F0>]``
...
.. class:: TOKEN_DEFAULT_DACL
    ...
    Alias for :class:`_TOKEN_DEFAULT_DACL`

.. class:: PTOKEN_DEFAULT_DACL

    Pointer to :class:`_TOKEN_DEFAULT_DACL`

.. class:: _TOKEN_DEFAULT_DACL

    .. attribute:: DefaultDacl
...
.. class:: TOKEN_GROUPS
    ...
    Alias for :class:`_TOKEN_GROUPS`

.. class:: PTOKEN_GROUPS

    Pointer to :class:`_TOKEN_GROUPS`
...
.. class:: _TOKEN_GROUPS
    ...
    .. attribute:: Groups
        ...
        :class:`SID_AND_ATTRIBUTES` ``[<winstruct.ComplexArrayExpression object at 0x03BD4D50>]``

_TOKEN_OWNER
''''''''''''
.. class:: TOKEN_OWNER

    Alias for :class:`_TOKEN_OWNER`

.. class:: PTOKEN_OWNER

    Pointer to :class:`_TOKEN_OWNER`
...
''''''''''''''''''''
.. class:: PTOKEN_PRIMARY_GROUP

    Pointer to :class:`_TOKEN_PRIMARY_GROUP`

.. class:: TOKEN_PRIMARY_GROUP

    Alias for :class:`_TOKEN_PRIMARY_GROUP`
...
.. class:: PTOKEN_SOURCE
    ...
    Pointer to :class:`_TOKEN_SOURCE`

.. class:: TOKEN_SOURCE

    Alias for :class:`_TOKEN_SOURCE`

.. class:: _TOKEN_SOURCE

    .. attribute:: SourceName

        :class:`CHAR` ``[<winstruct.ComplexArrayExpression object at 0x03BD4F50>]``
...
_TOKEN_STATISTICS
'''''''''''''''''
.. class:: PTOKEN_STATISTICS

    Pointer to :class:`_TOKEN_STATISTICS`

.. class:: TOKEN_STATISTICS

    Alias for :class:`_TOKEN_STATISTICS`
...
.. class:: _TOKEN_STATISTICS
    ...
    .. attribute:: DynamicCharged

        :class:`DWORD`


    .. attribute:: DynamicAvailable
...
.. class:: TOKEN_ORIGIN
    ...
    Alias for :class:`_TOKEN_ORIGIN`

.. class:: PTOKEN_ORIGIN

    Pointer to :class:`_TOKEN_ORIGIN`

.. class:: _TOKEN_ORIGIN

    .. attribute:: OriginatingLogonSession

        :class:`LUID`

_TOKEN_LINKED_TOKEN
'''''''''''''''''''
.. class:: PTOKEN_LINKED_TOKEN

    Pointer to :class:`_TOKEN_LINKED_TOKEN`

.. class:: TOKEN_LINKED_TOKEN

    Alias for :class:`_TOKEN_LINKED_TOKEN`

.. class:: _TOKEN_LINKED_TOKEN

    .. attribute:: LinkedToken
...
.. class:: TOKEN_MANDATORY_POLICY
    ...
    Alias for :class:`_TOKEN_MANDATORY_POLICY`

.. class:: PTOKEN_MANDATORY_POLICY

    Pointer to :class:`_TOKEN_MANDATORY_POLICY`

.. class:: _TOKEN_MANDATORY_POLICY
...
''''''''''''''''''''''''
.. class:: SID_AND_ATTRIBUTES_HASH

    Alias for :class:`_SID_AND_ATTRIBUTES_HASH`

.. class:: PSID_AND_ATTRIBUTES_HASH

    Pointer to :class:`_SID_AND_ATTRIBUTES_HASH`

.. class:: _SID_AND_ATTRIBUTES_HASH
    ...
    .. attribute:: Hash
        ...
        :class:`SID_HASH_ENTRY` ``[<winstruct.ComplexArrayExpression object at 0x03BDB5B0>]``

_TOKEN_APPCONTAINER_INFORMATION
'''''''''''''''''''''''''''''''
.. class:: PTOKEN_APPCONTAINER_INFORMATION

    Pointer to :class:`_TOKEN_APPCONTAINER_INFORMATION`

.. class:: TOKEN_APPCONTAINER_INFORMATION

    Alias for :class:`_TOKEN_APPCONTAINER_INFORMATION`

.. class:: _TOKEN_APPCONTAINER_INFORMATION

    .. attribute:: TokenAppContainer

        :class:`PSID`

_TOKEN_ACCESS_INFORMATION
'''''''''''''''''''''''''
.. class:: PTOKEN_ACCESS_INFORMATION

    Pointer to :class:`_TOKEN_ACCESS_INFORMATION`

.. class:: TOKEN_ACCESS_INFORMATION

    Alias for :class:`_TOKEN_ACCESS_INFORMATION`

.. class:: _TOKEN_ACCESS_INFORMATION
    ...
    .. attribute:: AppContainerNumber

        :class:`DWORD`


    .. attribute:: PackageSid

        :class:`PSID`


    .. attribute:: CapabilitiesHash

        :class:`PSID_AND_ATTRIBUTES_HASH`


    .. attribute:: TrustLevelSid

        :class:`PSID`


    .. attribute:: SecurityAttributes

        :class:`PSECURITY_ATTRIBUTES_OPAQUE`

_TOKEN_GROUPS_AND_PRIVILEGES
''''''''''''''''''''''''''''
.. class:: TOKEN_GROUPS_AND_PRIVILEGES

    Alias for :class:`_TOKEN_GROUPS_AND_PRIVILEGES`

.. class:: PTOKEN_GROUPS_AND_PRIVILEGES

    Pointer to :class:`_TOKEN_GROUPS_AND_PRIVILEGES`
...
.. class:: _TOKEN_GROUPS_AND_PRIVILEGES
    ...
    .. attribute:: RestrictedSidCount

        :class:`DWORD`


    .. attribute:: RestrictedSidLength

        :class:`DWORD`


    .. attribute:: RestrictedSids
...
''''''''''''''''''''''''''''''''''''
.. class:: PTOKEN_SECURITY_ATTRIBUTE_FQBN_VALUE

    Pointer to :class:`_TOKEN_SECURITY_ATTRIBUTE_FQBN_VALUE`

.. class:: TOKEN_SECURITY_ATTRIBUTE_FQBN_VALUE

    Alias for :class:`_TOKEN_SECURITY_ATTRIBUTE_FQBN_VALUE`

.. class:: _TOKEN_SECURITY_ATTRIBUTE_FQBN_VALUE
...
''''''''''''''''''''''''''''''''''''''''''''
.. class:: PTOKEN_SECURITY_ATTRIBUTE_OCTET_STRING_VALUE

    Pointer to :class:`_TOKEN_SECURITY_ATTRIBUTE_OCTET_STRING_VALUE`

.. class:: TOKEN_SECURITY_ATTRIBUTE_OCTET_STRING_VALUE

    Alias for :class:`_TOKEN_SECURITY_ATTRIBUTE_OCTET_STRING_VALUE`

.. class:: _TOKEN_SECURITY_ATTRIBUTE_OCTET_STRING_VALUE
...
''''''''''''''''''''''''''''''''''
.. class:: TOKEN_SECURITY_ATTRIBUTE_V1_UNION

    Alias for :class:`_TOKEN_SECURITY_ATTRIBUTE_V1_UNION`

.. class:: _TOKEN_SECURITY_ATTRIBUTE_V1_UNION
...
''''''''''''''''''''''''''''
.. class:: TOKEN_SECURITY_ATTRIBUTE_V1

    Alias for :class:`_TOKEN_SECURITY_ATTRIBUTE_V1`

.. class:: PTOKEN_SECURITY_ATTRIBUTE_V1

    Pointer to :class:`_TOKEN_SECURITY_ATTRIBUTE_V1`

.. class:: _TOKEN_SECURITY_ATTRIBUTE_V1
...
.. class:: TOKEN_SECURITY_ATTRIBUTES_INFORMATION_UNION
    ...
    Alias for :class:`_TOKEN_SECURITY_ATTRIBUTES_INFORMATION_UNION`

.. class:: _TOKEN_SECURITY_ATTRIBUTES_INFORMATION_UNION
...
''''''''''''''''''''''''''''''''''''''
.. class:: PTOKEN_SECURITY_ATTRIBUTES_INFORMATION

    Pointer to :class:`_TOKEN_SECURITY_ATTRIBUTES_INFORMATION`

.. class:: TOKEN_SECURITY_ATTRIBUTES_INFORMATION

    Alias for :class:`_TOKEN_SECURITY_ATTRIBUTES_INFORMATION`

.. class:: _TOKEN_SECURITY_ATTRIBUTES_INFORMATION
...
.. class:: _PROVIDER_ENUMERATION_INFO
    ...
    .. attribute:: TraceProviderInfoArray
        ...
        :class:`TRACE_PROVIDER_INFO` ``[<winstruct.ComplexArrayExpression object at 0x03BE05F0>]``
...
.. class:: tagBITMAPINFO
    ...
    .. attribute:: bmiColors
        ...
        :class:`RGBQUAD` ``[<winstruct.ComplexArrayExpression object at 0x03BE3770>]``
...
.. class:: tagBITMAPCOREINFO
    ...
    .. attribute:: bmciColors
        ...
        :class:`RGBTRIPLE` ``[<winstruct.ComplexArrayExpression object at 0x03BE38D0>]``
...
.. class:: _PEB_LDR_DATA
    ...
    .. attribute:: Reserved1
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x03BE7590>]``


    .. attribute:: Reserved2

        :class:`PVOID` ``[<winstruct.ComplexArrayExpression object at 0x03BE7610>]``
...
.. class:: _RTL_USER_PROCESS_PARAMETERS
    ...
    .. attribute:: CurrentDirectores
        ...
        :class:`RTL_DRIVE_LETTER_CURDIR` ``[<winstruct.ComplexArrayExpression object at 0x03BFF350>]``
...
.. class:: _PEB
    ...
    .. attribute:: Reserved1
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x03BFF990>]``
    ...
    .. attribute:: Reserved2
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x03BFFA50>]``
    ...
    .. attribute:: TlsBitmapBits
        ...
        :class:`DWORD` ``[<winstruct.ComplexArrayExpression object at 0x03BFFEF0>]``
    ...
    .. attribute:: GdiHandleBuffer
        ...
        :class:`PVOID` ``[<winstruct.ComplexArrayExpression object at 0x03C05710>]``


    .. attribute:: GdiHandleBuffer2

        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x03C05770>]``
    ...
    .. attribute:: TlsExpansionBitmapBits
        ...
        :class:`DWORD` ``[<winstruct.ComplexArrayExpression object at 0x03C05850>]``
...
.. class:: _LDR_DATA_TABLE_ENTRY
    ...
    .. attribute:: Reserved1
        ...
        :class:`PVOID` ``[<winstruct.ComplexArrayExpression object at 0x03C16210>]``
    ...
    .. attribute:: Reserved2
        ...
        :class:`PVOID` ``[<winstruct.ComplexArrayExpression object at 0x03C162D0>]``
    ...
    .. attribute:: Reserved5
        ...
        :class:`PVOID` ``[<winstruct.ComplexArrayExpression object at 0x03C164F0>]``
...
.. class:: _IMAGE_SECTION_HEADER
    ...
    .. attribute:: Name
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x03C16950>]``
...
.. class:: _IMAGE_OPTIONAL_HEADER64
    ...
    .. attribute:: DataDirectory
        ...
        :class:`IMAGE_DATA_DIRECTORY` ``[<winstruct.ComplexArrayExpression object at 0x03C1B490>]``
...
.. class:: _IMAGE_OPTIONAL_HEADER
    ...
    .. attribute:: DataDirectory
        ...
        :class:`IMAGE_DATA_DIRECTORY` ``[<winstruct.ComplexArrayExpression object at 0x03C1BDB0>]``
...
.. class:: _IMAGE_IMPORT_BY_NAME
    ...
    .. attribute:: Name
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x03C202D0>]``
...
.. class:: _PSAPI_WORKING_SET_INFORMATION
    ...
    .. attribute:: WorkingSetInfo
        ...
        :class:`PSAPI_WORKING_SET_BLOCK` ``[<winstruct.ComplexArrayExpression object at 0x03C24410>]``
...
.. class:: _PSAPI_WORKING_SET_INFORMATION32
    ...
    .. attribute:: WorkingSetInfo
        ...
        :class:`PSAPI_WORKING_SET_BLOCK32` ``[<winstruct.ComplexArrayExpression object at 0x03C244D0>]``
...
.. class:: _PSAPI_WORKING_SET_INFORMATION64
    ...
    .. attribute:: WorkingSetInfo
        ...
        :class:`PSAPI_WORKING_SET_BLOCK64` ``[<winstruct.ComplexArrayExpression object at 0x03C24590>]``
...
.. class:: _FLOATING_SAVE_AREA
    ...
    .. attribute:: RegisterArea
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x03C2AC30>]``
...
.. class:: _CONTEXT32
    ...
    .. attribute:: ExtendedRegisters
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x03C2E430>]``
...
.. class:: _WOW64_FLOATING_SAVE_AREA
    ...
    .. attribute:: RegisterArea
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x03C2E790>]``
...
.. class:: _WOW64_CONTEXT
    ...
    .. attribute:: ExtendedRegisters
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x03C2EF50>]``
...
.. class:: _XSAVE_FORMAT_64
    ...
    .. attribute:: FloatRegisters
        ...
        :class:`M128A` ``[<winstruct.ComplexArrayExpression object at 0x03C325F0>]``


    .. attribute:: XmmRegisters

        :class:`M128A` ``[<winstruct.ComplexArrayExpression object at 0x03C32670>]``


    .. attribute:: Reserved4

        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x03C326F0>]``
...
.. class:: _XSAVE_FORMAT_32
    ...
    .. attribute:: FloatRegisters
        ...
        :class:`M128A` ``[<winstruct.ComplexArrayExpression object at 0x03C32C10>]``


    .. attribute:: XmmRegisters

        :class:`M128A` ``[<winstruct.ComplexArrayExpression object at 0x03C32C70>]``


    .. attribute:: Reserved4

        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x03C32D10>]``


    .. attribute:: StackControl

        :class:`DWORD` ``[<winstruct.ComplexArrayExpression object at 0x03C32D50>]``
...
.. class:: _TMP_DUMMYSTRUCTNAME
    ...
    .. attribute:: Header
        ...
        :class:`M128A` ``[<winstruct.ComplexArrayExpression object at 0x03C32E90>]``


    .. attribute:: Legacy

        :class:`M128A` ``[<winstruct.ComplexArrayExpression object at 0x03C32F10>]``
...
.. class:: _CONTEXT64
    ...
    .. attribute:: VectorRegister
        ...
        :class:`M128A` ``[<winstruct.ComplexArrayExpression object at 0x03C3A1D0>]``
...
.. class:: tagPROCESSENTRY32W
    ...
    .. attribute:: szExeFile
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03C3A750>]``
...
.. class:: tagPROCESSENTRY32
    ...
    .. attribute:: szExeFile
        ...
        :class:`CHAR` ``[<winstruct.ComplexArrayExpression object at 0x03C3AB10>]``
...
.. class:: _OSVERSIONINFOA
    ...
    .. attribute:: szCSDVersion
        ...
        :class:`CHAR` ``[<winstruct.ComplexArrayExpression object at 0x03C3D250>]``
...
.. class:: _OSVERSIONINFOW
    ...
    .. attribute:: szCSDVersion
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03C3D450>]``
...
.. class:: _OSVERSIONINFOEXA
    ...
    .. attribute:: szCSDVersion
        ...
        :class:`CHAR` ``[<winstruct.ComplexArrayExpression object at 0x03C3D670>]``
...
.. class:: _OSVERSIONINFOEXW
    ...
    .. attribute:: szCSDVersion
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03C3D9F0>]``
...
.. class:: _EXCEPTION_RECORD
    ...
    .. attribute:: ExceptionInformation
        ...
        :class:`ULONG_PTR` ``[<winstruct.ComplexArrayExpression object at 0x03C3DF70>]``
...
.. class:: _EXCEPTION_RECORD32
    ...
    .. attribute:: ExceptionInformation
        ...
        :class:`DWORD` ``[<winstruct.ComplexArrayExpression object at 0x03C43170>]``
...
.. class:: _EXCEPTION_RECORD64
    ...
    .. attribute:: ExceptionInformation
        ...
        :class:`DWORD64` ``[<winstruct.ComplexArrayExpression object at 0x03C43390>]``
...
.. class:: _DEBUG_PROCESSOR_IDENTIFICATION_AMD64
    ...
    .. attribute:: VendorString
        ...
        :class:`CHAR` ``[<winstruct.ComplexArrayExpression object at 0x03C437B0>]``
...
.. class:: _DEBUG_PROCESSOR_IDENTIFICATION_IA64
    ...
    .. attribute:: VendorString
        ...
        :class:`CHAR` ``[<winstruct.ComplexArrayExpression object at 0x03C439D0>]``
...
.. class:: _DEBUG_PROCESSOR_IDENTIFICATION_X86
    ...
    .. attribute:: VendorString
        ...
        :class:`CHAR` ``[<winstruct.ComplexArrayExpression object at 0x03C43B90>]``
...
.. class:: _SYSTEM_MODULE32
    ...
    .. attribute:: Reserved
        ...
        :class:`ULONG` ``[<winstruct.ComplexArrayExpression object at 0x03C4A0B0>]``
    ...
    .. attribute:: ImageName
        ...
        :class:`CHAR` ``[<winstruct.ComplexArrayExpression object at 0x03C4A3D0>]``
...
.. class:: _SYSTEM_MODULE64
    ...
    .. attribute:: Reserved
        ...
        :class:`ULONG` ``[<winstruct.ComplexArrayExpression object at 0x03C4A470>]``
    ...
    .. attribute:: ImageName
        ...
        :class:`CHAR` ``[<winstruct.ComplexArrayExpression object at 0x03C4A790>]``
...
.. class:: _SYSTEM_MODULE_INFORMATION32
    ...
    .. attribute:: Modules
        ...
        :class:`SYSTEM_MODULE32` ``[<winstruct.ComplexArrayExpression object at 0x03C4A870>]``
...
.. class:: _SYSTEM_MODULE_INFORMATION64
    ...
    .. attribute:: Modules
        ...
        :class:`SYSTEM_MODULE64` ``[<winstruct.ComplexArrayExpression object at 0x03C4A950>]``
...
.. class:: _DEBUG_STACK_FRAME
    ...
    .. attribute:: Params
        ...
        :class:`ULONG64` ``[<winstruct.ComplexArrayExpression object at 0x03C4D290>]``


    .. attribute:: Reserved

        :class:`ULONG64` ``[<winstruct.ComplexArrayExpression object at 0x03C4D2F0>]``
...
.. class:: _SID_IDENTIFIER_AUTHORITY
    ...
    .. attribute:: Value
        ...
        :class:`BYTE` ``[<winstruct.ComplexArrayExpression object at 0x03C52C50>]``
...
.. class:: CATALOG_INFO_
    ...
    .. attribute:: wszCatalogFile
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03C56410>]``
...
.. class:: _SYSTEM_HANDLE_INFORMATION
    ...
    .. attribute:: Handles
        ...
        :class:`SYSTEM_HANDLE` ``[<winstruct.ComplexArrayExpression object at 0x03C56990>]``
...
.. class:: _SYSTEM_HANDLE_INFORMATION64
    ...
    .. attribute:: Handles
        ...
        :class:`SYSTEM_HANDLE64` ``[<winstruct.ComplexArrayExpression object at 0x03C56A90>]``
...
.. class:: __PUBLIC_OBJECT_TYPE_INFORMATION
    ...
    .. attribute:: Reserved
        ...
        :class:`ULONG` ``[<winstruct.ComplexArrayExpression object at 0x03C56BB0>]``
...
.. class:: _PUBLIC_OBJECT_BASIC_INFORMATION
    ...
    .. attribute:: Reserved
        ...
        :class:`ULONG` ``[<winstruct.ComplexArrayExpression object at 0x03C56D90>]``
...
.. class:: _DEBUG_VALUE_TMP_UNION
    ...
    .. attribute:: F80Bytes
        ...
        :class:`UCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03C5C510>]``


    .. attribute:: F82Bytes

        :class:`UCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03C5C590>]``


    .. attribute:: F128Bytes

        :class:`UCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03C5C610>]``


    .. attribute:: VI8

        :class:`UCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03C5C690>]``


    .. attribute:: VI16

        :class:`USHORT` ``[<winstruct.ComplexArrayExpression object at 0x03C5C6F0>]``


    .. attribute:: VI32

        :class:`ULONG` ``[<winstruct.ComplexArrayExpression object at 0x03C5C770>]``


    .. attribute:: VI64

        :class:`ULONG64` ``[<winstruct.ComplexArrayExpression object at 0x03C5C7F0>]``


    .. attribute:: VF32

        :class:`FLOAT` ``[<winstruct.ComplexArrayExpression object at 0x03C5C870>]``


    .. attribute:: VF64

        :class:`DOUBLE` ``[<winstruct.ComplexArrayExpression object at 0x03C5C8F0>]``
    ...
    .. attribute:: RawBytes
        ...
        :class:`UCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03C5C9F0>]``
...
.. class:: _DEBUG_MODULE_PARAMETERS
    ...
    .. attribute:: Reserved
        ...
        :class:`ULONG64` ``[<winstruct.ComplexArrayExpression object at 0x03C605F0>]``
...
.. class:: _RTL_UNLOAD_EVENT_TRACE
    ...
    .. attribute:: ImageName
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03C60EF0>]``


    .. attribute:: Version

        :class:`ULONG` ``[<winstruct.ComplexArrayExpression object at 0x03C60F70>]``
...
.. class:: _RTL_UNLOAD_EVENT_TRACE32
    ...
    .. attribute:: ImageName
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03C64210>]``


    .. attribute:: Version

        :class:`ULONG` ``[<winstruct.ComplexArrayExpression object at 0x03C64290>]``
...
.. class:: _RTL_UNLOAD_EVENT_TRACE64
    ...
    .. attribute:: ImageName
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03C64510>]``


    .. attribute:: Version

        :class:`ULONG` ``[<winstruct.ComplexArrayExpression object at 0x03C64590>]``
...
.. class:: _FILE_FS_ATTRIBUTE_INFORMATION
    ...
    .. attribute:: FileSystemName
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03C646D0>]``
...
.. class:: _FILE_FS_LABEL_INFORMATION
    ...
    .. attribute:: VolumeLabel
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03C647D0>]``
...
.. class:: _FILE_FS_OBJECTID_INFORMATION
    ...
    .. attribute:: ObjectId
        ...
        :class:`UCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03C64CD0>]``


    .. attribute:: ExtendedInfo

        :class:`UCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03C64D30>]``
...
.. class:: _FILE_FS_DRIVER_PATH_INFORMATION
    ...
    .. attribute:: DriverName
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03C64E50>]``
...
.. class:: _FILE_FS_DRIVER_PATH_INFORMATION
    ...
    .. attribute:: DriverName
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03C64F90>]``
...
.. class:: _FILE_FS_VOLUME_INFORMATION
    ...
    .. attribute:: VolumeLabel
        ...
        :class:`WCHAR` ``[<winstruct.ComplexArrayExpression object at 0x03C6A150>]``
...
.. class:: _API_SET_NAMESPACE_ARRAY
    ...
    .. attribute:: Array
        ...
        :class:`API_SET_NAMESPACE_ENTRY` ``[<winstruct.ComplexArrayExpression object at 0x03BEA390>]``
...
.. class:: _API_SET_VALUE_ARRAY_V2
    ...
    .. attribute:: Array
        ...
        :class:`API_SET_VALUE_ENTRY_V2` ``[<winstruct.ComplexArrayExpression object at 0x03BEA650>]``
...
.. class:: _API_SET_NAMESPACE_ARRAY_V2
    ...
    .. attribute:: Array
        ...
        :class:`API_SET_NAMESPACE_ENTRY_V2` ``[<winstruct.ComplexArrayExpression object at 0x03BEA910>]``
...
.. class:: _API_SET_VALUE_ARRAY_V4
    ...
    .. attribute:: Array
        ...
        :class:`API_SET_VALUE_ENTRY_V2` ``[<winstruct.ComplexArrayExpression object at 0x03BEAA70>]``
...
.. class:: _API_SET_NAMESPACE_ARRAY_V4
    ...
    .. attribute:: Array
        ...
        :class:`API_SET_NAMESPACE_ENTRY` ``[<winstruct.ComplexArrayExpression object at 0x03BEAC90>]``
...
.. class:: NDR_FORMAT_CHARACTER
    ...
    .. attribute:: FC_SMALL(3)


    .. attribute:: FC_USMALL(4)


    .. attribute:: FC_WCHAR(5)


    .. attribute:: FC_SHORT(6)


    .. attribute:: FC_USHORT(7)


    .. attribute:: FC_LONG(8)


    .. attribute:: FC_ULONG(9)


    .. attribute:: FC_FLOAT(10)


    .. attribute:: FC_HYPER(11)


    .. attribute:: FC_DOUBLE(12)


    .. attribute:: FC_ENUM16(13)


    .. attribute:: FC_ENUM32(14)


    .. attribute:: FC_IGNORE(15)


    .. attribute:: FC_ERROR_STATUS_T(16)
    ...
    .. attribute:: FC_STRUCT(21)


    .. attribute:: FC_PSTRUCT(22)


    .. attribute:: FC_CSTRUCT(23)


    .. attribute:: FC_CPSTRUCT(24)


    .. attribute:: FC_CVSTRUCT(25)


    .. attribute:: FC_BOGUS_STRUCT(26)


    .. attribute:: FC_CARRAY(27)


    .. attribute:: FC_CVARRAY(28)


    .. attribute:: FC_SMFARRAY(29)


    .. attribute:: FC_LGFARRAY(30)


    .. attribute:: FC_SMVARRAY(31)


    .. attribute:: FC_LGVARRAY(32)


    .. attribute:: FC_BOGUS_ARRAY(33)


    .. attribute:: FC_C_CSTRING(34)


    .. attribute:: FC_C_BSTRING(35)


    .. attribute:: FC_C_SSTRING(36)


    .. attribute:: FC_C_WSTRING(37)


    .. attribute:: FC_CSTRING(38)


    .. attribute:: FC_BSTRING(39)


    .. attribute:: FC_SSTRING(40)


    .. attribute:: FC_WSTRING(41)


    .. attribute:: FC_ENCAPSULATED_UNION(42)


    .. attribute:: FC_NON_ENCAPSULATED_UNION(43)


    .. attribute:: FC_BYTE_COUNT_POINTER(44)


    .. attribute:: FC_TRANSMIT_AS(45)


    .. attribute:: FC_REPRESENT_AS(46)


    .. attribute:: FC_IP(47)


    .. attribute:: FC_BIND_CONTEXT(48)


    .. attribute:: FC_BIND_GENERIC(49)


    .. attribute:: FC_BIND_PRIMITIVE(50)


    .. attribute:: FC_AUTO_HANDLE(51)


    .. attribute:: FC_CALLBACK_HANDLE(52)


    .. attribute:: FC_UNUSED1(53)


    .. attribute:: FC_POINTER(54)


    .. attribute:: FC_ALIGNM2(55)


    .. attribute:: FC_ALIGNM4(56)


    .. attribute:: FC_ALIGNM8(57)


    .. attribute:: FC_UNUSED2(58)


    .. attribute:: FC_UNUSED3(59)


    .. attribute:: FC_UNUSED4(60)


    .. attribute:: FC_STRUCTPAD1(61)


    .. attribute:: FC_STRUCTPAD2(62)


    .. attribute:: FC_STRUCTPAD3(63)


    .. attribute:: FC_STRUCTPAD4(64)


    .. attribute:: FC_STRUCTPAD5(65)


    .. attribute:: FC_STRUCTPAD6(66)


    .. attribute:: FC_STRUCTPAD7(67)


    .. attribute:: FC_STRING_SIZED(68)


    .. attribute:: FC_UNUSED5(69)


    .. attribute:: FC_NO_REPEAT(70)


    .. attribute:: FC_FIXED_REPEAT(71)


    .. attribute:: FC_VARIABLE_REPEAT(72)


    .. attribute:: FC_FIXED_OFFSET(73)


    .. attribute:: FC_VARIABLE_OFFSET(74)


    .. attribute:: FC_PP(75)


    .. attribute:: FC_EMBEDDED_COMPLEX(76)


    .. attribute:: FC_IN_PARAM(77)


    .. attribute:: FC_IN_PARAM_BASETYPE(78)


    .. attribute:: FC_IN_PARAM_NO_FREE_INST(79)


    .. attribute:: FC_IN_OUT_PARAM(80)


    .. attribute:: FC_OUT_PARAM(81)


    .. attribute:: FC_RETURN_PARAM(82)


    .. attribute:: FC_RETURN_PARAM_BASETYPE(83)


    .. attribute:: FC_DEREFERENCE(84)


    .. attribute:: FC_DIV_2(85)


    .. attribute:: FC_MULT_2(86)


    .. attribute:: FC_ADD_1(87)


    .. attribute:: FC_SUB_1(88)


    .. attribute:: FC_CALLBACK(89)


    .. attribute:: FC_CONSTANT_IID(90)
    ...
    .. attribute:: FC_SPLIT_DEREFERENCE(116)


    .. attribute:: FC_SPLIT_DIV_2(117)


    .. attribute:: FC_SPLIT_MULT_2(118)


    .. attribute:: FC_SPLIT_ADD_1(119)


    .. attribute:: FC_SPLIT_SUB_1(120)


    .. attribute:: FC_SPLIT_CALLBACK(121)


    .. attribute:: FC_HARD_STRUCT(177)


    .. attribute:: FC_TRANSMIT_AS_PTR(178)


    .. attribute:: FC_REPRESENT_AS_PTR(179)


    .. attribute:: FC_USER_MARSHAL(180)


    .. attribute:: FC_PIPE(181)


    .. attribute:: FC_BLKHOLE(182)


    .. attribute:: FC_RANGE(183)


    .. attribute:: FC_INT3264(184)


    .. attribute:: FC_UINT3264(185)
...
.. class:: DNS_FREE_TYPE
    ...
    .. attribute:: DnsFreeRecordList(1)


    .. attribute:: DnsFreeParsedMessageFields(2)
...
''''''''''''''''''''''
.. class:: KEY_INFORMATION_CLASS

    Alias for :class:`_KEY_INFORMATION_CLASS`


.. class:: _KEY_INFORMATION_CLASS


    .. attribute:: KeyBasicInformation(0)


    .. attribute:: KeyNodeInformation(1)


    .. attribute:: KeyFullInformation(2)


    .. attribute:: KeyNameInformation(3)


    .. attribute:: KeyCachedInformation(4)


    .. attribute:: KeyFlagsInformation(5)


    .. attribute:: KeyVirtualizationInformation(6)


    .. attribute:: KeyHandleTagsInformation(7)


    .. attribute:: KeyTrustInformation(8)


    .. attribute:: KeyLayerInformation(9)
...
.. class:: ACTIVATEOPTIONS
    ...
    .. attribute:: AO_PRELAUNCH(33554432)
...
.. class:: PACKAGE_EXECUTION_STATE
    ...
    .. attribute:: PES_RUNNING(1)


    .. attribute:: PES_SUSPENDING(2)


    .. attribute:: PES_SUSPENDED(3)


    .. attribute:: PES_TERMINATED(4)
...
.. class:: SYM_TYPE
    ...
    .. attribute:: SymExport(4)


    .. attribute:: SymDeferred(5)
    ...
    .. attribute:: SymVirtual(8)


    .. attribute:: NumSymTypes(9)
...
.. class:: BasicType
    ...
    .. attribute:: btULong(14)


    .. attribute:: btCurrency(25)


    .. attribute:: btDate(26)


    .. attribute:: btVariant(27)


    .. attribute:: btComplex(28)
...
.. class:: DataKind
    ...
    .. attribute:: DataIsUnknown(0)


    .. attribute:: DataIsLocal(1)


    .. attribute:: DataIsStaticLocal(2)


    .. attribute:: DataIsParam(3)


    .. attribute:: DataIsObjectPtr(4)


    .. attribute:: DataIsFileStatic(5)


    .. attribute:: DataIsGlobal(6)


    .. attribute:: DataIsMember(7)


    .. attribute:: DataIsStaticMember(8)


    .. attribute:: DataIsConstant(9)
...
.. class:: UdtKind
    ...
    .. attribute:: UdtStruct(0)


    .. attribute:: UdtClass(1)


    .. attribute:: UdtUnion(2)

_SymTagEnum
'''''''''''
.. class:: SymTagEnum

    Alias for :class:`_SymTagEnum`


.. class:: _SymTagEnum


    .. attribute:: SymTagNull(0)


    .. attribute:: SymTagExe(1)


    .. attribute:: SymTagCompiland(2)


    .. attribute:: SymTagCompilandDetails(3)


    .. attribute:: SymTagCompilandEnv(4)


    .. attribute:: SymTagFunction(5)


    .. attribute:: SymTagBlock(6)


    .. attribute:: SymTagData(7)


    .. attribute:: SymTagAnnotation(8)


    .. attribute:: SymTagLabel(9)


    .. attribute:: SymTagPublicSymbol(10)


    .. attribute:: SymTagUDT(11)


    .. attribute:: SymTagEnum(12)


    .. attribute:: SymTagFunctionType(13)


    .. attribute:: SymTagPointerType(14)


    .. attribute:: SymTagArrayType(15)


    .. attribute:: SymTagBaseType(16)


    .. attribute:: SymTagTypedef(17)


    .. attribute:: SymTagBaseClass(18)


    .. attribute:: SymTagFriend(19)


    .. attribute:: SymTagFunctionArgType(20)


    .. attribute:: SymTagFuncDebugStart(21)


    .. attribute:: SymTagFuncDebugEnd(22)


    .. attribute:: SymTagUsingNamespace(23)


    .. attribute:: SymTagVTableShape(24)


    .. attribute:: SymTagVTable(25)


    .. attribute:: SymTagCustom(26)


    .. attribute:: SymTagThunk(27)


    .. attribute:: SymTagCustomType(28)


    .. attribute:: SymTagManagedType(29)


    .. attribute:: SymTagDimension(30)

_IMAGEHLP_EXTENDED_OPTIONS
''''''''''''''''''''''''''
.. class:: IMAGEHLP_EXTENDED_OPTIONS

    Alias for :class:`_IMAGEHLP_EXTENDED_OPTIONS`


.. class:: _IMAGEHLP_EXTENDED_OPTIONS


    .. attribute:: SYMOPT_EX_DISABLEACCESSTIMEUPDATE(0)


    .. attribute:: SYMOPT_EX_MAX(1)


    .. attribute:: SYMOPT_EX_LASTVALIDDEBUGDIRECTORY(2)
...
.. class:: CBA_EVENT_SEVERITY
    ...
    Alias for :class:`_CBA_EVENT_SEVERITY`


.. class:: _CBA_EVENT_SEVERITY


    .. attribute:: sevInfo(0)


    .. attribute:: sevProblem(1)


    .. attribute:: sevAttn(2)


    .. attribute:: sevFatal(3)
...
.. class:: ADDRESS_MODE
    ...
    .. attribute:: AddrMode1632(1)


    .. attribute:: AddrModeReal(2)
...
.. class:: _OBJECT_INFORMATION_CLASS
    ...
    .. attribute:: ObjectTypesInformation(3)


    .. attribute:: ObjectHandleFlagInformation(4)


    .. attribute:: ObjectSessionInformation(5)


    .. attribute:: ObjectSessionObjectInformation(6)


    .. attribute:: MaxObjectInfoClass(7)
...
.. class:: WBEM_GENUS_TYPE
    ...
    Alias for :class:`tag_WBEM_GENUS_TYPE`


.. class:: tag_WBEM_GENUS_TYPE


    .. attribute:: WBEM_GENUS_CLASS(1)


    .. attribute:: WBEM_GENUS_INSTANCE(2)
...
.. class:: WBEM_CONNECT_OPTIONS
    ...
    Alias for :class:`tag_WBEM_CONNECT_OPTIONS`


.. class:: tag_WBEM_CONNECT_OPTIONS


    .. attribute:: WBEM_FLAG_CONNECT_REPOSITORY_ONLY(64)


    .. attribute:: WBEM_FLAG_CONNECT_USE_MAX_WAIT(128)


    .. attribute:: WBEM_FLAG_CONNECT_PROVIDERS(256)

tag_WBEM_QUERY_FLAG_TYPE
''''''''''''''''''''''''
.. class:: WBEM_QUERY_FLAG_TYPE

    Alias for :class:`tag_WBEM_QUERY_FLAG_TYPE`


.. class:: tag_WBEM_QUERY_FLAG_TYPE


    .. attribute:: WBEM_FLAG_DEEP(0)


    .. attribute:: WBEM_FLAG_SHALLOW(1)


    .. attribute:: WBEM_FLAG_PROTOTYPE(2)
...
.. class:: WMIDPREQUESTCODE
    ...
    .. attribute:: WMI_GET_ALL_DATA(0)


    .. attribute:: WMI_GET_SINGLE_INSTANCE(1)


    .. attribute:: WMI_SET_SINGLE_INSTANCE(2)


    .. attribute:: WMI_SET_SINGLE_ITEM(3)


    .. attribute:: WMI_ENABLE_EVENTS(4)


    .. attribute:: WMI_DISABLE_EVENTS(5)


    .. attribute:: WMI_ENABLE_COLLECTION(6)


    .. attribute:: WMI_DISABLE_COLLECTION(7)


    .. attribute:: WMI_REGINFO(8)


    .. attribute:: WMI_EXECUTE_METHOD(9)
