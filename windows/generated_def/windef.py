...
LDAP_NO_LIMIT = make_flag("LDAP_NO_LIMIT", 0)
LDAP_PORT = make_flag("LDAP_PORT", 389)
LDAP_SSL_PORT = make_flag("LDAP_SSL_PORT", 636)
LDAP_GC_PORT = make_flag("LDAP_GC_PORT", 3268)
LDAP_SSL_GC_PORT = make_flag("LDAP_SSL_GC_PORT", 3269)
LDAP_AUTH_SIMPLE = make_flag("LDAP_AUTH_SIMPLE", 0x80)
LDAP_AUTH_SASL = make_flag("LDAP_AUTH_SASL", 0x83)
LDAP_AUTH_OTHERKIND = make_flag("LDAP_AUTH_OTHERKIND", 0x86)
LDAP_AUTH_SICILY = make_flag("LDAP_AUTH_SICILY", ( LDAP_AUTH_OTHERKIND | 0x0200 ))
LDAP_AUTH_MSN = make_flag("LDAP_AUTH_MSN", ( LDAP_AUTH_OTHERKIND | 0x0800 ))
LDAP_AUTH_NTLM = make_flag("LDAP_AUTH_NTLM", ( LDAP_AUTH_OTHERKIND | 0x1000 ))
LDAP_AUTH_DPA = make_flag("LDAP_AUTH_DPA", ( LDAP_AUTH_OTHERKIND | 0x2000 ))
LDAP_AUTH_NEGOTIATE = make_flag("LDAP_AUTH_NEGOTIATE", ( LDAP_AUTH_OTHERKIND | 0x0400 ))
LDAP_AUTH_SSPI = make_flag("LDAP_AUTH_SSPI", LDAP_AUTH_NEGOTIATE)
LDAP_AUTH_DIGEST = make_flag("LDAP_AUTH_DIGEST", ( LDAP_AUTH_OTHERKIND | 0x4000 ))
LDAP_AUTH_EXTERNAL = make_flag("LDAP_AUTH_EXTERNAL", ( LDAP_AUTH_OTHERKIND | 0x0020 ))
LDAP_SCOPE_BASE = make_flag("LDAP_SCOPE_BASE", 0x00)
LDAP_SCOPE_ONELEVEL = make_flag("LDAP_SCOPE_ONELEVEL", 0x01)
LDAP_SCOPE_SUBTREE = make_flag("LDAP_SCOPE_SUBTREE", 0x02)
LDAP_PAGED_RESULT_OID_STRING = make_flag("LDAP_PAGED_RESULT_OID_STRING", "1.2.840.113556.1.4.319")
LDAP_SERVER_CROSSDOM_MOVE_TARGET_OID = make_flag("LDAP_SERVER_CROSSDOM_MOVE_TARGET_OID", "1.2.840.113556.1.4.521")
LDAP_SERVER_DIRSYNC_OID = make_flag("LDAP_SERVER_DIRSYNC_OID", "1.2.840.113556.1.4.841")
LDAP_SERVER_DOMAIN_SCOPE_OID = make_flag("LDAP_SERVER_DOMAIN_SCOPE_OID", "1.2.840.113556.1.4.1339")
LDAP_SERVER_EXTENDED_DN_OID = make_flag("LDAP_SERVER_EXTENDED_DN_OID", "1.2.840.113556.1.4.529")
LDAP_SERVER_GET_STATS_OID = make_flag("LDAP_SERVER_GET_STATS_OID", "1.2.840.113556.1.4.970")
LDAP_SERVER_LAZY_COMMIT_OID = make_flag("LDAP_SERVER_LAZY_COMMIT_OID", "1.2.840.113556.1.4.619")
LDAP_SERVER_PERMISSIVE_MODIFY_OID = make_flag("LDAP_SERVER_PERMISSIVE_MODIFY_OID", "1.2.840.113556.1.4.1413")
LDAP_SERVER_NOTIFICATION_OID = make_flag("LDAP_SERVER_NOTIFICATION_OID", "1.2.840.113556.1.4.528")
LDAP_SERVER_RESP_SORT_OID = make_flag("LDAP_SERVER_RESP_SORT_OID", "1.2.840.113556.1.4.474")
LDAP_SERVER_SD_FLAGS_OID = make_flag("LDAP_SERVER_SD_FLAGS_OID", "1.2.840.113556.1.4.801")
LDAP_SERVER_SEARCH_OPTIONS_OID = make_flag("LDAP_SERVER_SEARCH_OPTIONS_OID", "1.2.840.113556.1.4.1340")
LDAP_SERVER_SORT_OID = make_flag("LDAP_SERVER_SORT_OID", "1.2.840.113556.1.4.473")
LDAP_SERVER_SHOW_DELETED_OID = make_flag("LDAP_SERVER_SHOW_DELETED_OID", "1.2.840.113556.1.4.417")
LDAP_SERVER_TREE_DELETE_OID = make_flag("LDAP_SERVER_TREE_DELETE_OID", "1.2.840.113556.1.4.805")
LDAP_SERVER_VERIFY_NAME_OID = make_flag("LDAP_SERVER_VERIFY_NAME_OID", "1.2.840.113556.1.4.1338")
LDAP_CONTROL_VLVREQUEST = make_flag("LDAP_CONTROL_VLVREQUEST", "2.16.840.1.113730.3.4.9")
LDAP_CONTROL_VLVRESPONSE = make_flag("LDAP_CONTROL_VLVRESPONSE", "2.16.840.1.113730.3.4.10")
LDAP_SERVER_ASQ_OID = make_flag("LDAP_SERVER_ASQ_OID", "1.2.840.113556.1.4.1504")
LDAP_SERVER_QUOTA_CONTROL_OID = make_flag("LDAP_SERVER_QUOTA_CONTROL_OID", "1.2.840.113556.1.4.1852")
LDAP_SERVER_RANGE_OPTION_OID = make_flag("LDAP_SERVER_RANGE_OPTION_OID", "1.2.840.113556.1.4.802")
LDAP_SERVER_SHUTDOWN_NOTIFY_OID = make_flag("LDAP_SERVER_SHUTDOWN_NOTIFY_OID", "1.2.840.113556.1.4.1907")
LDAP_SERVER_FORCE_UPDATE_OID = make_flag("LDAP_SERVER_FORCE_UPDATE_OID", "1.2.840.113556.1.4.1974")
LDAP_SERVER_RANGE_RETRIEVAL_NOERR_OID = make_flag("LDAP_SERVER_RANGE_RETRIEVAL_NOERR_OID", "1.2.840.113556.1.4.1948")
LDAP_SERVER_RODC_DCPROMO_OID = make_flag("LDAP_SERVER_RODC_DCPROMO_OID", "1.2.840.113556.1.4.1341")
LDAP_SERVER_DN_INPUT_OID = make_flag("LDAP_SERVER_DN_INPUT_OID", "1.2.840.113556.1.4.2026")
LDAP_SERVER_SHOW_DEACTIVATED_LINK_OID = make_flag("LDAP_SERVER_SHOW_DEACTIVATED_LINK_OID", "1.2.840.113556.1.4.2065")
LDAP_SERVER_SHOW_RECYCLED_OID = make_flag("LDAP_SERVER_SHOW_RECYCLED_OID", "1.2.840.113556.1.4.2064")
LDAP_SERVER_POLICY_HINTS_DEPRECATED_OID = make_flag("LDAP_SERVER_POLICY_HINTS_DEPRECATED_OID", "1.2.840.113556.1.4.2066")
LDAP_SERVER_DIRSYNC_EX_OID = make_flag("LDAP_SERVER_DIRSYNC_EX_OID", "1.2.840.113556.1.4.2090")
LDAP_SERVER_UPDATE_STATS_OID = make_flag("LDAP_SERVER_UPDATE_STATS_OID", "1.2.840.113556.1.4.2205")
LDAP_SERVER_TREE_DELETE_EX_OID = make_flag("LDAP_SERVER_TREE_DELETE_EX_OID", "1.2.840.113556.1.4.2204")
LDAP_SERVER_SEARCH_HINTS_OID = make_flag("LDAP_SERVER_SEARCH_HINTS_OID", "1.2.840.113556.1.4.2206")
LDAP_SERVER_EXPECTED_ENTRY_COUNT_OID = make_flag("LDAP_SERVER_EXPECTED_ENTRY_COUNT_OID", "1.2.840.113556.1.4.2211")
LDAP_SERVER_POLICY_HINTS_OID = make_flag("LDAP_SERVER_POLICY_HINTS_OID", "1.2.840.113556.1.4.2239")
LDAP_SERVER_SET_OWNER_OID = make_flag("LDAP_SERVER_SET_OWNER_OID", "1.2.840.113556.1.4.2255")
LDAP_SERVER_BYPASS_QUOTA_OID = make_flag("LDAP_SERVER_BYPASS_QUOTA_OID", "1.2.840.113556.1.4.2256")
LDAP_SERVER_LINK_TTL_OID = make_flag("LDAP_SERVER_LINK_TTL_OID", "1.2.840.113556.1.4.2309")
LDAP_CAP_ACTIVE_DIRECTORY_OID = make_flag("LDAP_CAP_ACTIVE_DIRECTORY_OID", "1.2.840.113556.1.4.800")
LDAP_CAP_ACTIVE_DIRECTORY_LDAP_INTEG_OID = make_flag("LDAP_CAP_ACTIVE_DIRECTORY_LDAP_INTEG_OID", "1.2.840.113556.1.4.1791")
LDAP_CAP_ACTIVE_DIRECTORY_V51_OID = make_flag("LDAP_CAP_ACTIVE_DIRECTORY_V51_OID", "1.2.840.113556.1.4.1670")
LDAP_CAP_ACTIVE_DIRECTORY_ADAM_DIGEST_OID = make_flag("LDAP_CAP_ACTIVE_DIRECTORY_ADAM_DIGEST_OID", "1.2.840.113556.1.4.1880")
LDAP_CAP_ACTIVE_DIRECTORY_ADAM_OID = make_flag("LDAP_CAP_ACTIVE_DIRECTORY_ADAM_OID", "1.2.840.113556.1.4.1851")
LDAP_CAP_ACTIVE_DIRECTORY_PARTIAL_SECRETS_OID = make_flag("LDAP_CAP_ACTIVE_DIRECTORY_PARTIAL_SECRETS_OID", "1.2.840.113556.1.4.1920")
LDAP_CAP_ACTIVE_DIRECTORY_V60_OID = make_flag("LDAP_CAP_ACTIVE_DIRECTORY_V60_OID", "1.2.840.113556.1.4.1935")
LDAP_CAP_ACTIVE_DIRECTORY_V61_R2_OID = make_flag("LDAP_CAP_ACTIVE_DIRECTORY_V61_R2_OID", "1.2.840.113556.1.4.2080")
LDAP_CAP_ACTIVE_DIRECTORY_W8_OID = make_flag("LDAP_CAP_ACTIVE_DIRECTORY_W8_OID", "1.2.840.113556.1.4.2237")
LDAP_CONTROL_SERVER = make_flag("LDAP_CONTROL_SERVER", 0x01)
LDAP_CONTROL_CLIENT = make_flag("LDAP_CONTROL_CLIENT", 0x02)
LBER_USE_DER = make_flag("LBER_USE_DER", 0x01)
LDAP_VERSION1 = make_flag("LDAP_VERSION1", 1)
LDAP_VERSION2 = make_flag("LDAP_VERSION2", 2)
LDAP_VERSION3 = make_flag("LDAP_VERSION3", 3)
LDAP_VERSION = make_flag("LDAP_VERSION", LDAP_VERSION2)
LDAP_OPT_API_INFO = make_flag("LDAP_OPT_API_INFO", 0x00)
LDAP_OPT_DESC = make_flag("LDAP_OPT_DESC", 0x01)
LDAP_OPT_DEREF = make_flag("LDAP_OPT_DEREF", 0x02)
LDAP_OPT_SIZELIMIT = make_flag("LDAP_OPT_SIZELIMIT", 0x03)
LDAP_OPT_TIMELIMIT = make_flag("LDAP_OPT_TIMELIMIT", 0x04)
LDAP_OPT_THREAD_FN_PTRS = make_flag("LDAP_OPT_THREAD_FN_PTRS", 0x05)
LDAP_OPT_REBIND_FN = make_flag("LDAP_OPT_REBIND_FN", 0x06)
LDAP_OPT_REBIND_ARG = make_flag("LDAP_OPT_REBIND_ARG", 0x07)
LDAP_OPT_REFERRALS = make_flag("LDAP_OPT_REFERRALS", 0x08)
LDAP_OPT_RESTART = make_flag("LDAP_OPT_RESTART", 0x09)
LDAP_OPT_SSL = make_flag("LDAP_OPT_SSL", 0x0a)
LDAP_OPT_IO_FN_PTRS = make_flag("LDAP_OPT_IO_FN_PTRS", 0x0b)
LDAP_OPT_CACHE_FN_PTRS = make_flag("LDAP_OPT_CACHE_FN_PTRS", 0x0d)
LDAP_OPT_CACHE_STRATEGY = make_flag("LDAP_OPT_CACHE_STRATEGY", 0x0e)
LDAP_OPT_CACHE_ENABLE = make_flag("LDAP_OPT_CACHE_ENABLE", 0x0f)
LDAP_OPT_REFERRAL_HOP_LIMIT = make_flag("LDAP_OPT_REFERRAL_HOP_LIMIT", 0x10)
LDAP_OPT_PROTOCOL_VERSION = make_flag("LDAP_OPT_PROTOCOL_VERSION", 0x11)
LDAP_OPT_VERSION = make_flag("LDAP_OPT_VERSION", 0x11)
LDAP_OPT_API_FEATURE_INFO = make_flag("LDAP_OPT_API_FEATURE_INFO", 0x15)
LDAP_OPT_HOST_NAME = make_flag("LDAP_OPT_HOST_NAME", 0x30)
LDAP_OPT_ERROR_NUMBER = make_flag("LDAP_OPT_ERROR_NUMBER", 0x31)
LDAP_OPT_ERROR_STRING = make_flag("LDAP_OPT_ERROR_STRING", 0x32)
LDAP_OPT_SERVER_ERROR = make_flag("LDAP_OPT_SERVER_ERROR", 0x33)
LDAP_OPT_SERVER_EXT_ERROR = make_flag("LDAP_OPT_SERVER_EXT_ERROR", 0x34)
LDAP_OPT_HOST_REACHABLE = make_flag("LDAP_OPT_HOST_REACHABLE", 0x3E)
LDAP_OPT_PING_KEEP_ALIVE = make_flag("LDAP_OPT_PING_KEEP_ALIVE", 0x36)
LDAP_OPT_PING_WAIT_TIME = make_flag("LDAP_OPT_PING_WAIT_TIME", 0x37)
LDAP_OPT_PING_LIMIT = make_flag("LDAP_OPT_PING_LIMIT", 0x38)
LDAP_OPT_DNSDOMAIN_NAME = make_flag("LDAP_OPT_DNSDOMAIN_NAME", 0x3B)
LDAP_OPT_GETDSNAME_FLAGS = make_flag("LDAP_OPT_GETDSNAME_FLAGS", 0x3D)
LDAP_OPT_PROMPT_CREDENTIALS = make_flag("LDAP_OPT_PROMPT_CREDENTIALS", 0x3F)
LDAP_OPT_AUTO_RECONNECT = make_flag("LDAP_OPT_AUTO_RECONNECT", 0x91)
LDAP_OPT_SSPI_FLAGS = make_flag("LDAP_OPT_SSPI_FLAGS", 0x92)
LDAP_OPT_SSL_INFO = make_flag("LDAP_OPT_SSL_INFO", 0x93)
LDAP_OPT_TLS = make_flag("LDAP_OPT_TLS", LDAP_OPT_SSL)
LDAP_OPT_TLS_INFO = make_flag("LDAP_OPT_TLS_INFO", LDAP_OPT_SSL_INFO)
LDAP_OPT_SIGN = make_flag("LDAP_OPT_SIGN", 0x95)
LDAP_OPT_ENCRYPT = make_flag("LDAP_OPT_ENCRYPT", 0x96)
LDAP_OPT_SASL_METHOD = make_flag("LDAP_OPT_SASL_METHOD", 0x97)
LDAP_OPT_AREC_EXCLUSIVE = make_flag("LDAP_OPT_AREC_EXCLUSIVE", 0x98)
LDAP_OPT_SECURITY_CONTEXT = make_flag("LDAP_OPT_SECURITY_CONTEXT", 0x99)
LDAP_OPT_ROOTDSE_CACHE = make_flag("LDAP_OPT_ROOTDSE_CACHE", 0x9a)
LDAP_OPT_TCP_KEEPALIVE = make_flag("LDAP_OPT_TCP_KEEPALIVE", 0x40)
LDAP_OPT_FAST_CONCURRENT_BIND = make_flag("LDAP_OPT_FAST_CONCURRENT_BIND", 0x41)
LDAP_OPT_SEND_TIMEOUT = make_flag("LDAP_OPT_SEND_TIMEOUT", 0x42)
LDAP_OPT_SCH_FLAGS = make_flag("LDAP_OPT_SCH_FLAGS", 0x43)
LDAP_OPT_SOCKET_BIND_ADDRESSES = make_flag("LDAP_OPT_SOCKET_BIND_ADDRESSES", 0x44)
LDAP_RES_BIND = make_flag("LDAP_RES_BIND", 0x61)
LDAP_RES_SEARCH_ENTRY = make_flag("LDAP_RES_SEARCH_ENTRY", 0x64)
LDAP_RES_SEARCH_RESULT = make_flag("LDAP_RES_SEARCH_RESULT", 0x65)
LDAP_RES_MODIFY = make_flag("LDAP_RES_MODIFY", 0x67)
LDAP_RES_ADD = make_flag("LDAP_RES_ADD", 0x69)
LDAP_RES_DELETE = make_flag("LDAP_RES_DELETE", 0x6b)
LDAP_RES_MODRDN = make_flag("LDAP_RES_MODRDN", 0x6d)
LDAP_RES_COMPARE = make_flag("LDAP_RES_COMPARE", 0x6f)
LDAP_RES_SESSION = make_flag("LDAP_RES_SESSION", 0x72)
LDAP_RES_REFERRAL = make_flag("LDAP_RES_REFERRAL", 0x73)
LDAP_RES_EXTENDED = make_flag("LDAP_RES_EXTENDED", 0x78)
LDAP_RES_ANY = make_flag("LDAP_RES_ANY", ( -1L ))
LDAP_INVALID_CMD = make_flag("LDAP_INVALID_CMD", 0xff)
LDAP_INVALID_RES = make_flag("LDAP_INVALID_RES", 0xff)
...
SID_NULL = make_flag("SID_NULL", "S-1-0-0")
SID_WORLD = make_flag("SID_WORLD", "S-1-1-0")
SID_LOCAL = make_flag("SID_LOCAL", "S-1-2-0")
SID_CREATOR_OWNER_ID = make_flag("SID_CREATOR_OWNER_ID", "S-1-3-0")
SID_CREATOR_GROUP_ID = make_flag("SID_CREATOR_GROUP_ID", "S-1-3-1")
SECURITY_DIALUP_RID = make_flag("SECURITY_DIALUP_RID", "S-1-5-1")
SECURITY_NETWORK_RID = make_flag("SECURITY_NETWORK_RID", "S-1-5-2")
SECURITY_BATCH_RID = make_flag("SECURITY_BATCH_RID", "S-1-5-3")
SECURITY_INTERACTIVE_RID = make_flag("SECURITY_INTERACTIVE_RID", "S-1-5-4")
SECURITY_SERVICE_RID = make_flag("SECURITY_SERVICE_RID", "S-1-5-6")
SECURITY_ANONYMOUS_LOGON_RID = make_flag("SECURITY_ANONYMOUS_LOGON_RID", "S-1-5-7")
SECURITY_PROXY_RID = make_flag("SECURITY_PROXY_RID", "S-1-5-8")
SECURITY_ENTERPRISE_CONTROLLERS_RID = make_flag("SECURITY_ENTERPRISE_CONTROLLERS_RID", "S-1-5-9")
SECURITY_PRINCIPAL_SELF_RID = make_flag("SECURITY_PRINCIPAL_SELF_RID", "S-1-5-10")
SECURITY_AUTHENTICATED_USER_RID = make_flag("SECURITY_AUTHENTICATED_USER_RID", "S-1-5-11")
SECURITY_RESTRICTED_CODE_RID = make_flag("SECURITY_RESTRICTED_CODE_RID", "S-1-5-12")
SECURITY_TERMINAL_SERVER_RID = make_flag("SECURITY_TERMINAL_SERVER_RID", "S-1-5-13")
SECURITY_LOCAL_SYSTEM_RID = make_flag("SECURITY_LOCAL_SYSTEM_RID", "S-1-5-18")
SECURITY_NT_NON_UNIQUE = make_flag("SECURITY_NT_NON_UNIQUE", "S-1-5-21")
SECURITY_BUILTIN_DOMAIN_RID = make_flag("SECURITY_BUILTIN_DOMAIN_RID", "S-1-5-32")
...
SDDL_OBJECT_INHERIT_ACE = make_flag("SDDL_OBJECT_INHERIT_ACE", "CI")
SDDL_CONTAINER_INHERIT_ACE = make_flag("SDDL_CONTAINER_INHERIT_ACE", "OI")
SDDL_NO_PROPAGATE_INHERIT_ACE = make_flag("SDDL_NO_PROPAGATE_INHERIT_ACE", "NP")
SDDL_INHERIT_ONLY_ACE = make_flag("SDDL_INHERIT_ONLY_ACE", "IO")
SDDL_INHERITED_ACE = make_flag("SDDL_INHERITED_ACE", "ID")
SDDL_SUCCESSFUL_ACCESS_ACE_FLAG = make_flag("SDDL_SUCCESSFUL_ACCESS_ACE_FLAG", "SA")
SDDL_FAILED_ACCESS_ACE_FLAG = make_flag("SDDL_FAILED_ACCESS_ACE_FLAG", "FA")
SDDL_DOMAIN_ADMINISTRATORS = make_flag("SDDL_DOMAIN_ADMINISTRATORS", "DA")
SDDL_DOMAIN_GUESTS = make_flag("SDDL_DOMAIN_GUESTS", "DG")
SDDL_DOMAIN_USERS = make_flag("SDDL_DOMAIN_USERS", "DU")
SDDL_ENTERPRISE_DOMAIN_CONTROLLERS = make_flag("SDDL_ENTERPRISE_DOMAIN_CONTROLLERS", "ED")
SDDL_DOMAIN_DOMAIN_CONTROLLERS = make_flag("SDDL_DOMAIN_DOMAIN_CONTROLLERS", "DD")
SDDL_DOMAIN_COMPUTERS = make_flag("SDDL_DOMAIN_COMPUTERS", "DC")
SDDL_BUILTIN_ADMINISTRATORS = make_flag("SDDL_BUILTIN_ADMINISTRATORS", "BA")
SDDL_BUILTIN_GUESTS = make_flag("SDDL_BUILTIN_GUESTS", "BG")
SDDL_BUILTIN_USERS = make_flag("SDDL_BUILTIN_USERS", "BU")
SDDL_LOCAL_ADMIN = make_flag("SDDL_LOCAL_ADMIN", "LA")
SDDL_LOCAL_GUEST = make_flag("SDDL_LOCAL_GUEST", "LG")
SDDL_ACCOUNT_OPERATORS = make_flag("SDDL_ACCOUNT_OPERATORS", "AO")
SDDL_BACKUP_OPERATORS = make_flag("SDDL_BACKUP_OPERATORS", "BO")
SDDL_PRINTER_OPERATORS = make_flag("SDDL_PRINTER_OPERATORS", "PO")
SDDL_SERVER_OPERATORS = make_flag("SDDL_SERVER_OPERATORS", "SO")
SDDL_AUTHENTICATED_USERS = make_flag("SDDL_AUTHENTICATED_USERS", "AU")
SDDL_PERSONAL_SELF = make_flag("SDDL_PERSONAL_SELF", "PS")
SDDL_CREATOR_OWNER = make_flag("SDDL_CREATOR_OWNER", "CO")
SDDL_CREATOR_GROUP = make_flag("SDDL_CREATOR_GROUP", "CG")
SDDL_LOCAL_SYSTEM = make_flag("SDDL_LOCAL_SYSTEM", "SY")
SDDL_POWER_USERS = make_flag("SDDL_POWER_USERS", "PU")
SDDL_EVERYONE = make_flag("SDDL_EVERYONE", "WD")
SDDL_REPLICATOR = make_flag("SDDL_REPLICATOR", "RE")
SDDL_INTERACTIVE = make_flag("SDDL_INTERACTIVE", "IU")
SDDL_NETWORK = make_flag("SDDL_NETWORK", "NU")
SDDL_SERVICE = make_flag("SDDL_SERVICE", "SU")
SDDL_RESTRICTED_CODE = make_flag("SDDL_RESTRICTED_CODE", "RC")
SDDL_WRITE_RESTRICTED_CODE = make_flag("SDDL_WRITE_RESTRICTED_CODE", "WR")
SDDL_ANONYMOUS = make_flag("SDDL_ANONYMOUS", "AN")
SDDL_SCHEMA_ADMINISTRATORS = make_flag("SDDL_SCHEMA_ADMINISTRATORS", "SA")
SDDL_CERT_SERV_ADMINISTRATORS = make_flag("SDDL_CERT_SERV_ADMINISTRATORS", "CA")
SDDL_RAS_SERVERS = make_flag("SDDL_RAS_SERVERS", "RS")
SDDL_ENTERPRISE_ADMINS = make_flag("SDDL_ENTERPRISE_ADMINS", "EA")
SDDL_GROUP_POLICY_ADMINS = make_flag("SDDL_GROUP_POLICY_ADMINS", "PA")
SDDL_ALIAS_PREW2KCOMPACC = make_flag("SDDL_ALIAS_PREW2KCOMPACC", "RU")
SDDL_LOCAL_SERVICE = make_flag("SDDL_LOCAL_SERVICE", "LS")
SDDL_NETWORK_SERVICE = make_flag("SDDL_NETWORK_SERVICE", "NS")
SDDL_REMOTE_DESKTOP = make_flag("SDDL_REMOTE_DESKTOP", "RD")
SDDL_NETWORK_CONFIGURATION_OPS = make_flag("SDDL_NETWORK_CONFIGURATION_OPS", "NO")
SDDL_PERFMON_USERS = make_flag("SDDL_PERFMON_USERS", "MU")
SDDL_PERFLOG_USERS = make_flag("SDDL_PERFLOG_USERS", "LU")
SDDL_IIS_USERS = make_flag("SDDL_IIS_USERS", "IS")
SDDL_CRYPTO_OPERATORS = make_flag("SDDL_CRYPTO_OPERATORS", "CY")
SDDL_OWNER_RIGHTS = make_flag("SDDL_OWNER_RIGHTS", "OW")
SDDL_EVENT_LOG_READERS = make_flag("SDDL_EVENT_LOG_READERS", "ER")
SDDL_ENTERPRISE_RO_DCs = make_flag("SDDL_ENTERPRISE_RO_DCs", "RO")
SDDL_CERTSVC_DCOM_ACCESS = make_flag("SDDL_CERTSVC_DCOM_ACCESS", "CD")
SDDL_ALL_APP_PACKAGES = make_flag("SDDL_ALL_APP_PACKAGES", "AC")
SDDL_RDS_REMOTE_ACCESS_SERVERS = make_flag("SDDL_RDS_REMOTE_ACCESS_SERVERS", "RA")
SDDL_RDS_ENDPOINT_SERVERS = make_flag("SDDL_RDS_ENDPOINT_SERVERS", "ES")
SDDL_RDS_MANAGEMENT_SERVERS = make_flag("SDDL_RDS_MANAGEMENT_SERVERS", "MS")
SDDL_USER_MODE_DRIVERS = make_flag("SDDL_USER_MODE_DRIVERS", "UD")
SDDL_HYPER_V_ADMINS = make_flag("SDDL_HYPER_V_ADMINS", "HA")
SDDL_CLONEABLE_CONTROLLERS = make_flag("SDDL_CLONEABLE_CONTROLLERS", "CN")
SDDL_ACCESS_CONTROL_ASSISTANCE_OPS = make_flag("SDDL_ACCESS_CONTROL_ASSISTANCE_OPS", "AA")
SDDL_REMOTE_MANAGEMENT_USERS = make_flag("SDDL_REMOTE_MANAGEMENT_USERS", "RM")
SDDL_AUTHORITY_ASSERTED = make_flag("SDDL_AUTHORITY_ASSERTED", "AS")
SDDL_SERVICE_ASSERTED = make_flag("SDDL_SERVICE_ASSERTED", "SS")
SDDL_PROTECTED_USERS = make_flag("SDDL_PROTECTED_USERS", "AP")
...
SDDL_OWNER = make_flag("SDDL_OWNER", "O")
SDDL_GROUP = make_flag("SDDL_GROUP", "G")
SDDL_DACL = make_flag("SDDL_DACL", "D")
SDDL_SACL = make_flag("SDDL_SACL", "S")
SDDL_PROTECTED = make_flag("SDDL_PROTECTED", "P")
SDDL_AUTO_INHERIT_REQ = make_flag("SDDL_AUTO_INHERIT_REQ", "AR")
SDDL_AUTO_INHERITED = make_flag("SDDL_AUTO_INHERITED", "AI")
SDDL_NULL_ACL = make_flag("SDDL_NULL_ACL", "NO_ACCESS_CONTROL")
SDDL_ACCESS_ALLOWED = make_flag("SDDL_ACCESS_ALLOWED", "A")
SDDL_ACCESS_DENIED = make_flag("SDDL_ACCESS_DENIED", "D")
SDDL_OBJECT_ACCESS_ALLOWED = make_flag("SDDL_OBJECT_ACCESS_ALLOWED", "OA")
SDDL_OBJECT_ACCESS_DENIED = make_flag("SDDL_OBJECT_ACCESS_DENIED", "OD")
SDDL_AUDIT = make_flag("SDDL_AUDIT", "AU")
SDDL_ALARM = make_flag("SDDL_ALARM", "AL")
SDDL_OBJECT_AUDIT = make_flag("SDDL_OBJECT_AUDIT", "OU")
SDDL_OBJECT_ALARM = make_flag("SDDL_OBJECT_ALARM", "OL")
SDDL_MANDATORY_LABEL = make_flag("SDDL_MANDATORY_LABEL", "ML")
SDDL_PROCESS_TRUST_LABEL = make_flag("SDDL_PROCESS_TRUST_LABEL", "TL")
SDDL_CALLBACK_ACCESS_ALLOWED = make_flag("SDDL_CALLBACK_ACCESS_ALLOWED", "XA")
SDDL_CALLBACK_ACCESS_DENIED = make_flag("SDDL_CALLBACK_ACCESS_DENIED", "XD")
SDDL_RESOURCE_ATTRIBUTE = make_flag("SDDL_RESOURCE_ATTRIBUTE", "RA")
SDDL_SCOPED_POLICY_ID = make_flag("SDDL_SCOPED_POLICY_ID", "SP")
SDDL_CALLBACK_AUDIT = make_flag("SDDL_CALLBACK_AUDIT", "XU")
SDDL_CALLBACK_OBJECT_ACCESS_ALLOWED = make_flag("SDDL_CALLBACK_OBJECT_ACCESS_ALLOWED", "ZA")
SDDL_CONTAINER_INHERIT = make_flag("SDDL_CONTAINER_INHERIT", "CI")
SDDL_OBJECT_INHERIT = make_flag("SDDL_OBJECT_INHERIT", "OI")
SDDL_NO_PROPAGATE = make_flag("SDDL_NO_PROPAGATE", "NP")
SDDL_INHERIT_ONLY = make_flag("SDDL_INHERIT_ONLY", "IO")
SDDL_INHERITED = make_flag("SDDL_INHERITED", "ID")
SDDL_AUDIT_SUCCESS = make_flag("SDDL_AUDIT_SUCCESS", "SA")
SDDL_AUDIT_FAILURE = make_flag("SDDL_AUDIT_FAILURE", "FA")
SDDL_READ_PROPERTY = make_flag("SDDL_READ_PROPERTY", "RP")
SDDL_WRITE_PROPERTY = make_flag("SDDL_WRITE_PROPERTY", "WP")
SDDL_CREATE_CHILD = make_flag("SDDL_CREATE_CHILD", "CC")
SDDL_DELETE_CHILD = make_flag("SDDL_DELETE_CHILD", "DC")
SDDL_LIST_CHILDREN = make_flag("SDDL_LIST_CHILDREN", "LC")
SDDL_SELF_WRITE = make_flag("SDDL_SELF_WRITE", "SW")
SDDL_LIST_OBJECT = make_flag("SDDL_LIST_OBJECT", "LO")
SDDL_DELETE_TREE = make_flag("SDDL_DELETE_TREE", "DT")
SDDL_CONTROL_ACCESS = make_flag("SDDL_CONTROL_ACCESS", "CR")
SDDL_READ_CONTROL = make_flag("SDDL_READ_CONTROL", "RC")
SDDL_WRITE_DAC = make_flag("SDDL_WRITE_DAC", "WD")
SDDL_WRITE_OWNER = make_flag("SDDL_WRITE_OWNER", "WO")
SDDL_STANDARD_DELETE = make_flag("SDDL_STANDARD_DELETE", "SD")
SDDL_GENERIC_ALL = make_flag("SDDL_GENERIC_ALL", "GA")
SDDL_GENERIC_READ = make_flag("SDDL_GENERIC_READ", "GR")
SDDL_GENERIC_WRITE = make_flag("SDDL_GENERIC_WRITE", "GW")
SDDL_GENERIC_EXECUTE = make_flag("SDDL_GENERIC_EXECUTE", "GX")
SDDL_FILE_ALL = make_flag("SDDL_FILE_ALL", "FA")
SDDL_FILE_READ = make_flag("SDDL_FILE_READ", "FR")
SDDL_FILE_WRITE = make_flag("SDDL_FILE_WRITE", "FW")
SDDL_FILE_EXECUTE = make_flag("SDDL_FILE_EXECUTE", "FX")
SDDL_KEY_ALL = make_flag("SDDL_KEY_ALL", "KA")
SDDL_KEY_READ = make_flag("SDDL_KEY_READ", "KR")
SDDL_KEY_WRITE = make_flag("SDDL_KEY_WRITE", "KW")
SDDL_KEY_EXECUTE = make_flag("SDDL_KEY_EXECUTE", "KX")
SDDL_NO_WRITE_UP = make_flag("SDDL_NO_WRITE_UP", "NW")
SDDL_NO_READ_UP = make_flag("SDDL_NO_READ_UP", "NR")
SDDL_NO_EXECUTE_UP = make_flag("SDDL_NO_EXECUTE_UP", "NX")
